...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	d0a50513          	add	a0,a0,-758 # 5d48 <malloc+0xe6>
...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
      ...
      5c:	65878793          	add	a5,a5,1624 # 96b0 <uninit>
      60:	0000c697          	auipc	a3,0xc
      64:	d6068693          	add	a3,a3,-672 # bdc0 <buf>
    if(uninit[i] != '\0'){
      ...
      74:	8082                	ret
{
      ...
      84:	ce850513          	add	a0,a0,-792 # 5d68 <malloc+0x106>
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	cd850513          	add	a0,a0,-808 # 5d80 <malloc+0x11e>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	cda50513          	add	a0,a0,-806 # 5da0 <malloc+0x13e>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	ca250513          	add	a0,a0,-862 # 5d88 <malloc+0x126>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	cae50513          	add	a0,a0,-850 # 5db0 <malloc+0x14e>
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	cac50513          	add	a0,a0,-852 # 5dd8 <malloc+0x176>
     134:	00005097          	auipc	ra,0x5
     138:	74e080e7          	jalr	1870(ra) # 5882 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	c9850513          	add	a0,a0,-872 # 5dd8 <malloc+0x176>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	c9458593          	add	a1,a1,-876 # 5de8 <malloc+0x186>
     15c:	00005097          	auipc	ra,0x5
     160:	6f6080e7          	jalr	1782(ra) # 5852 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	c7050513          	add	a0,a0,-912 # 5dd8 <malloc+0x176>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	c7458593          	add	a1,a1,-908 # 5df0 <malloc+0x18e>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	c4450513          	add	a0,a0,-956 # 5dd8 <malloc+0x176>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	c2e50513          	add	a0,a0,-978 # 5df8 <malloc+0x196>
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	ba450513          	add	a0,a0,-1116 # 5e20 <malloc+0x1be>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	b90a8a93          	add	s5,s5,-1136 # 5e20 <malloc+0x1be>
      int cc = write(fd, buf, sz);
     298:	0000ca17          	auipc	s4,0xc
     29c:	b28a0a13          	add	s4,s4,-1240 # bdc0 <buf>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     2a0:	6b0d                	lui	s6,0x3
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	b1e50513          	add	a0,a0,-1250 # 5e30 <malloc+0x1ce>
     ...
     338:	b1c50513          	add	a0,a0,-1252 # 5e50 <malloc+0x1ee>
     33c:	00006097          	auipc	ra,0x6
     340:	86e080e7          	jalr	-1938(ra) # 5baa <printf>
        exit(1);
     344:	4505                	li	a0,1
...
000000000000034e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     374:	af8a0a13          	add	s4,s4,-1288 # 5e68 <malloc+0x206>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     420:	a5450513          	add	a0,a0,-1452 # 5e70 <malloc+0x20e>
     424:	00005097          	auipc	ra,0x5
     428:	786080e7          	jalr	1926(ra) # 5baa <printf>
      exit(1);
     42c:	4505                	li	a0,1
     ...
     43e:	a4e50513          	add	a0,a0,-1458 # 5e88 <malloc+0x226>
     442:	00005097          	auipc	ra,0x5
     446:	768080e7          	jalr	1896(ra) # 5baa <printf>
      exit(1);
     44a:	4505                	li	a0,1
     ...
     45c:	a6050513          	add	a0,a0,-1440 # 5eb8 <malloc+0x256>
     460:	00005097          	auipc	ra,0x5
     464:	74a080e7          	jalr	1866(ra) # 5baa <printf>
      exit(1);
     468:	4505                	li	a0,1
     ...
     476:	a7650513          	add	a0,a0,-1418 # 5ee8 <malloc+0x286>
     47a:	00005097          	auipc	ra,0x5
     47e:	730080e7          	jalr	1840(ra) # 5baa <printf>
      exit(1);
     482:	4505                	li	a0,1
     ...
     494:	a6850513          	add	a0,a0,-1432 # 5ef8 <malloc+0x296>
     498:	00005097          	auipc	ra,0x5
     49c:	712080e7          	jalr	1810(ra) # 5baa <printf>
      exit(1);
     4a0:	4505                	li	a0,1
...
00000000000004aa <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4d2:	a5aa0a13          	add	s4,s4,-1446 # 5f28 <malloc+0x2c6>
    n = write(fds[1], "x", 1);
     4d6:	00006a97          	auipc	s5,0x6
     4da:	91aa8a93          	add	s5,s5,-1766 # 5df0 <malloc+0x18e>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     580:	9b450513          	add	a0,a0,-1612 # 5f30 <malloc+0x2ce>
     584:	00005097          	auipc	ra,0x5
     588:	626080e7          	jalr	1574(ra) # 5baa <printf>
      exit(1);
     58c:	4505                	li	a0,1
     ...
     59e:	9ae50513          	add	a0,a0,-1618 # 5f48 <malloc+0x2e6>
     5a2:	00005097          	auipc	ra,0x5
     5a6:	608080e7          	jalr	1544(ra) # 5baa <printf>
      exit(1);
     5aa:	4505                	li	a0,1
     ...
     5b8:	93450513          	add	a0,a0,-1740 # 5ee8 <malloc+0x286>
     5bc:	00005097          	auipc	ra,0x5
     5c0:	5ee080e7          	jalr	1518(ra) # 5baa <printf>
      exit(1);
     5c4:	4505                	li	a0,1
     ...
     5d2:	9aa50513          	add	a0,a0,-1622 # 5f78 <malloc+0x316>
     5d6:	00005097          	auipc	ra,0x5
     5da:	5d4080e7          	jalr	1492(ra) # 5baa <printf>
      exit(1);
     5de:	4505                	li	a0,1
     ...
     5f0:	9a450513          	add	a0,a0,-1628 # 5f90 <malloc+0x32e>
     5f4:	00005097          	auipc	ra,0x5
     5f8:	5b6080e7          	jalr	1462(ra) # 5baa <printf>
      exit(1);
     5fc:	4505                	li	a0,1
...
0000000000000606 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     646:	7a658593          	add	a1,a1,1958 # 5de8 <malloc+0x186>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     662:	77a50513          	add	a0,a0,1914 # 5dd8 <malloc+0x176>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     68e:	74e50513          	add	a0,a0,1870 # 5dd8 <malloc+0x176>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6a2:	73a50513          	add	a0,a0,1850 # 5dd8 <malloc+0x176>
  ...
  write(fd1, "abcdef", 6);
     ...
     6e0:	94458593          	add	a1,a1,-1724 # 6020 <malloc+0x3be>
     6e4:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     722:	6ba50513          	add	a0,a0,1722 # 5dd8 <malloc+0x176>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     766:	85e50513          	add	a0,a0,-1954 # 5fc0 <malloc+0x35e>
     76a:	00005097          	auipc	ra,0x5
     76e:	440080e7          	jalr	1088(ra) # 5baa <printf>
    exit(1);
     772:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     782:	86250513          	add	a0,a0,-1950 # 5fe0 <malloc+0x37e>
     786:	00005097          	auipc	ra,0x5
     78a:	424080e7          	jalr	1060(ra) # 5baa <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     78e:	8652                	mv	a2,s4
     790:	85d6                	mv	a1,s5
     792:	00006517          	auipc	a0,0x6
     796:	85e50513          	add	a0,a0,-1954 # 5ff0 <malloc+0x38e>
     79a:	00005097          	auipc	ra,0x5
     79e:	410080e7          	jalr	1040(ra) # 5baa <printf>
    exit(1);
     7a2:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7b2:	86250513          	add	a0,a0,-1950 # 6010 <malloc+0x3ae>
     7b6:	00005097          	auipc	ra,0x5
     7ba:	3f4080e7          	jalr	1012(ra) # 5baa <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     7be:	8652                	mv	a2,s4
     7c0:	85d6                	mv	a1,s5
     7c2:	00006517          	auipc	a0,0x6
     7c6:	82e50513          	add	a0,a0,-2002 # 5ff0 <malloc+0x38e>
     7ca:	00005097          	auipc	ra,0x5
     7ce:	3e0080e7          	jalr	992(ra) # 5baa <printf>
    exit(1);
     7d2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     7e4:	84850513          	add	a0,a0,-1976 # 6028 <malloc+0x3c6>
     7e8:	00005097          	auipc	ra,0x5
     7ec:	3c2080e7          	jalr	962(ra) # 5baa <printf>
    exit(1);
     7f0:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     802:	84a50513          	add	a0,a0,-1974 # 6048 <malloc+0x3e6>
     806:	00005097          	auipc	ra,0x5
     80a:	3a4080e7          	jalr	932(ra) # 5baa <printf>
    exit(1);
     80e:	4505                	li	a0,1
...
0000000000000818 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     836:	83650513          	add	a0,a0,-1994 # 6068 <malloc+0x406>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     84e:	84698993          	add	s3,s3,-1978 # 6090 <malloc+0x42e>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     852:	00006a97          	auipc	s5,0x6
     856:	876a8a93          	add	s5,s5,-1930 # 60c8 <malloc+0x466>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     89c:	7d050513          	add	a0,a0,2000 # 6068 <malloc+0x406>
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     8b6:	50e58593          	add	a1,a1,1294 # bdc0 <buf>
  ...
  if(unlink("small") < 0){
     ...
     8d8:	79450513          	add	a0,a0,1940 # 6068 <malloc+0x406>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     902:	77250513          	add	a0,a0,1906 # 6070 <malloc+0x40e>
     906:	00005097          	auipc	ra,0x5
     90a:	2a4080e7          	jalr	676(ra) # 5baa <printf>
    exit(1);
     90e:	4505                	li	a0,1
     ...
     920:	78450513          	add	a0,a0,1924 # 60a0 <malloc+0x43e>
     924:	00005097          	auipc	ra,0x5
     928:	286080e7          	jalr	646(ra) # 5baa <printf>
      exit(1);
     92c:	4505                	li	a0,1
     ...
     93e:	79e50513          	add	a0,a0,1950 # 60d8 <malloc+0x476>
     942:	00005097          	auipc	ra,0x5
     946:	268080e7          	jalr	616(ra) # 5baa <printf>
      exit(1);
     94a:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     95a:	7aa50513          	add	a0,a0,1962 # 6100 <malloc+0x49e>
     95e:	00005097          	auipc	ra,0x5
     962:	24c080e7          	jalr	588(ra) # 5baa <printf>
    exit(1);
     966:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     976:	7ae50513          	add	a0,a0,1966 # 6120 <malloc+0x4be>
     97a:	00005097          	auipc	ra,0x5
     97e:	230080e7          	jalr	560(ra) # 5baa <printf>
    exit(1);
     982:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     992:	7aa50513          	add	a0,a0,1962 # 6138 <malloc+0x4d6>
     996:	00005097          	auipc	ra,0x5
     99a:	214080e7          	jalr	532(ra) # 5baa <printf>
    exit(1);
     99e:	4505                	li	a0,1
...
00000000000009a8 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9c4:	79850513          	add	a0,a0,1944 # 6158 <malloc+0x4f6>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     ...
     9d8:	3ec90913          	add	s2,s2,1004 # bdc0 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  fd = open("big", O_RDONLY);
     ...
     a16:	74650513          	add	a0,a0,1862 # 6158 <malloc+0x4f6>
  ...
  n = 0;
    ...
    i = read(fd, buf, BSIZE);
     ...
     a2a:	39a90913          	add	s2,s2,922 # bdc0 <buf>
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a5e:	70650513          	add	a0,a0,1798 # 6160 <malloc+0x4fe>
     a62:	00005097          	auipc	ra,0x5
     a66:	148080e7          	jalr	328(ra) # 5baa <printf>
    exit(1);
     a6a:	4505                	li	a0,1
     ...
     a7c:	70850513          	add	a0,a0,1800 # 6180 <malloc+0x51e>
     a80:	00005097          	auipc	ra,0x5
     a84:	12a080e7          	jalr	298(ra) # 5baa <printf>
      exit(1);
     a88:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a98:	71450513          	add	a0,a0,1812 # 61a8 <malloc+0x546>
     a9c:	00005097          	auipc	ra,0x5
     aa0:	10e080e7          	jalr	270(ra) # 5baa <printf>
    exit(1);
     aa4:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ac4:	69850513          	add	a0,a0,1688 # 6158 <malloc+0x4f6>
     ...
     af0:	6dc50513          	add	a0,a0,1756 # 61c8 <malloc+0x566>
     af4:	00005097          	auipc	ra,0x5
     af8:	0b6080e7          	jalr	182(ra) # 5baa <printf>
        exit(1);
     afc:	4505                	li	a0,1
     ...
     b0e:	6e650513          	add	a0,a0,1766 # 61f0 <malloc+0x58e>
     b12:	00005097          	auipc	ra,0x5
     b16:	098080e7          	jalr	152(ra) # 5baa <printf>
      exit(1);
     b1a:	4505                	li	a0,1
     ...
     b2c:	6e050513          	add	a0,a0,1760 # 6208 <malloc+0x5a6>
     b30:	00005097          	auipc	ra,0x5
     b34:	07a080e7          	jalr	122(ra) # 5baa <printf>
      exit(1);
     b38:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b48:	6ec50513          	add	a0,a0,1772 # 6230 <malloc+0x5ce>
     b4c:	00005097          	auipc	ra,0x5
     b50:	05e080e7          	jalr	94(ra) # 5baa <printf>
    exit(1);
     b54:	4505                	li	a0,1
...
0000000000000b5e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b76:	6d650513          	add	a0,a0,1750 # 6248 <malloc+0x5e6>
  ...
  write(fd, "hello", SZ);
     ...
     b8e:	6ee58593          	add	a1,a1,1774 # 6278 <malloc+0x616>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     baa:	6a250513          	add	a0,a0,1698 # 6248 <malloc+0x5e6>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bc0:	68c50513          	add	a0,a0,1676 # 6248 <malloc+0x5e6>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bd6:	67650513          	add	a0,a0,1654 # 6248 <malloc+0x5e6>
  ...
  write(fd1, "yyy", 3);
     ...
     bea:	6da58593          	add	a1,a1,1754 # 62c0 <malloc+0x65e>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     c06:	1be58593          	add	a1,a1,446 # bdc0 <buf>
     c0a:	8526                	mv	a0,s1
  ...
  unlink("unlinkread");
     ...
     c52:	5fa50513          	add	a0,a0,1530 # 6248 <malloc+0x5e6>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c72:	5ea50513          	add	a0,a0,1514 # 6258 <malloc+0x5f6>
     c76:	00005097          	auipc	ra,0x5
     c7a:	f34080e7          	jalr	-204(ra) # 5baa <printf>
    exit(1);
     c7e:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c8e:	5f650513          	add	a0,a0,1526 # 6280 <malloc+0x61e>
     c92:	00005097          	auipc	ra,0x5
     c96:	f18080e7          	jalr	-232(ra) # 5baa <printf>
    exit(1);
     c9a:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     caa:	5fa50513          	add	a0,a0,1530 # 62a0 <malloc+0x63e>
     cae:	00005097          	auipc	ra,0x5
     cb2:	efc080e7          	jalr	-260(ra) # 5baa <printf>
    exit(1);
     cb6:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cc6:	60650513          	add	a0,a0,1542 # 62c8 <malloc+0x666>
     cca:	00005097          	auipc	ra,0x5
     cce:	ee0080e7          	jalr	-288(ra) # 5baa <printf>
    exit(1);
     cd2:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ce2:	60a50513          	add	a0,a0,1546 # 62e8 <malloc+0x686>
     ce6:	00005097          	auipc	ra,0x5
     cea:	ec4080e7          	jalr	-316(ra) # 5baa <printf>
    exit(1);
     cee:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     cfe:	60e50513          	add	a0,a0,1550 # 6308 <malloc+0x6a6>
     d02:	00005097          	auipc	ra,0x5
     d06:	ea8080e7          	jalr	-344(ra) # 5baa <printf>
    exit(1);
     d0a:	4505                	li	a0,1
...
0000000000000d14 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d62:	51a58593          	add	a1,a1,1306 # 6278 <malloc+0x616>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d82:	5b258593          	add	a1,a1,1458 # 6330 <malloc+0x6ce>
     d86:	00005517          	auipc	a0,0x5
     d8a:	5a250513          	add	a0,a0,1442 # 6328 <malloc+0x6c6>
  ...
  unlink("lf1");
     ...
     d9e:	58e50513          	add	a0,a0,1422 # 6328 <malloc+0x6c6>
     da2:	00005097          	auipc	ra,0x5
     da6:	ae0080e7          	jalr	-1312(ra) # 5882 <unlink>
  if(open("lf1", 0) >= 0){
     daa:	4581                	li	a1,0
     dac:	00005517          	auipc	a0,0x5
     db0:	57c50513          	add	a0,a0,1404 # 6328 <malloc+0x6c6>
  ...
  fd = open("lf2", 0);
     ...
     dc6:	56e50513          	add	a0,a0,1390 # 6330 <malloc+0x6ce>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     dde:	fe658593          	add	a1,a1,-26 # bdc0 <buf>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     dfe:	53658593          	add	a1,a1,1334 # 6330 <malloc+0x6ce>
     e02:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e14:	52050513          	add	a0,a0,1312 # 6330 <malloc+0x6ce>
     e18:	00005097          	auipc	ra,0x5
     e1c:	a6a080e7          	jalr	-1430(ra) # 5882 <unlink>
  if(link("lf2", "lf1") >= 0){
     e20:	00005597          	auipc	a1,0x5
     e24:	50858593          	add	a1,a1,1288 # 6328 <malloc+0x6c6>
     e28:	00005517          	auipc	a0,0x5
     e2c:	50850513          	add	a0,a0,1288 # 6330 <malloc+0x6ce>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e40:	4ec58593          	add	a1,a1,1260 # 6328 <malloc+0x6c6>
     e44:	00005517          	auipc	a0,0x5
     e48:	5f450513          	add	a0,a0,1524 # 6438 <malloc+0x7d6>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e6a:	4d250513          	add	a0,a0,1234 # 6338 <malloc+0x6d6>
     e6e:	00005097          	auipc	ra,0x5
     e72:	d3c080e7          	jalr	-708(ra) # 5baa <printf>
    exit(1);
     e76:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e86:	4ce50513          	add	a0,a0,1230 # 6350 <malloc+0x6ee>
     e8a:	00005097          	auipc	ra,0x5
     e8e:	d20080e7          	jalr	-736(ra) # 5baa <printf>
    exit(1);
     e92:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     ea2:	4ca50513          	add	a0,a0,1226 # 6368 <malloc+0x706>
     ea6:	00005097          	auipc	ra,0x5
     eaa:	d04080e7          	jalr	-764(ra) # 5baa <printf>
    exit(1);
     eae:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ebe:	4ce50513          	add	a0,a0,1230 # 6388 <malloc+0x726>
     ec2:	00005097          	auipc	ra,0x5
     ec6:	ce8080e7          	jalr	-792(ra) # 5baa <printf>
    exit(1);
     eca:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     eda:	4e250513          	add	a0,a0,1250 # 63b8 <malloc+0x756>
     ede:	00005097          	auipc	ra,0x5
     ee2:	ccc080e7          	jalr	-820(ra) # 5baa <printf>
    exit(1);
     ee6:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     ef6:	4de50513          	add	a0,a0,1246 # 63d0 <malloc+0x76e>
     efa:	00005097          	auipc	ra,0x5
     efe:	cb0080e7          	jalr	-848(ra) # 5baa <printf>
    exit(1);
     f02:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f12:	4da50513          	add	a0,a0,1242 # 63e8 <malloc+0x786>
     f16:	00005097          	auipc	ra,0x5
     f1a:	c94080e7          	jalr	-876(ra) # 5baa <printf>
    exit(1);
     f1e:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     f2e:	4e650513          	add	a0,a0,1254 # 6410 <malloc+0x7ae>
     f32:	00005097          	auipc	ra,0x5
     f36:	c78080e7          	jalr	-904(ra) # 5baa <printf>
    exit(1);
     f3a:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f4a:	4fa50513          	add	a0,a0,1274 # 6440 <malloc+0x7de>
     f4e:	00005097          	auipc	ra,0x5
     f52:	c5c080e7          	jalr	-932(ra) # 5baa <printf>
    exit(1);
     f56:	4505                	li	a0,1
...
0000000000000f60 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fb0:	4b4a0a13          	add	s4,s4,1204 # 6460 <malloc+0x7fe>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1002:	46250513          	add	a0,a0,1122 # 6460 <malloc+0x7fe>
  ...
  for(i = 0; i < N; i++){
    ...
    1072:	3fa50513          	add	a0,a0,1018 # 6468 <malloc+0x806>
    1076:	00005097          	auipc	ra,0x5
    107a:	b34080e7          	jalr	-1228(ra) # 5baa <printf>
    exit(1);
    107e:	4505                	li	a0,1
    ...
    1092:	3fa50513          	add	a0,a0,1018 # 6488 <malloc+0x826>
    1096:	00005097          	auipc	ra,0x5
    109a:	b14080e7          	jalr	-1260(ra) # 5baa <printf>
      exit(1);
    109e:	4505                	li	a0,1
    ...
    10ae:	3fe50513          	add	a0,a0,1022 # 64a8 <malloc+0x846>
    10b2:	00005097          	auipc	ra,0x5
    10b6:	af8080e7          	jalr	-1288(ra) # 5baa <printf>
      exit(1);
    10ba:	4505                	li	a0,1
...
00000000000010c4 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10e0:	3ec98993          	add	s3,s3,1004 # 64c8 <malloc+0x866>
    10e4:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    111c:	3c050513          	add	a0,a0,960 # 64d8 <malloc+0x876>
    1120:	00005097          	auipc	ra,0x5
    1124:	a8a080e7          	jalr	-1398(ra) # 5baa <printf>
      exit(1);
    1128:	4505                	li	a0,1
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    1144:	4584b483          	ld	s1,1112(s1) # 8598 <__SDATA_BEGIN__>
...
badarg(char *s)
{
    ...
    117a:	35048493          	add	s1,s1,848 # c350 <buf+0x590>
  for(int i = 0; i < 50000; i++){
    ...
    1188:	bfc98993          	add	s3,s3,-1028 # 5d80 <malloc+0x11e>
    argv[0] = (char*)0xffffffff;
...
00000000000011b0 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1212:	4c278793          	add	a5,a5,1218 # 76d0 <malloc+0x1a6e>
  ...
  if(pid == 0){
    ...
    1248:	46478793          	add	a5,a5,1124 # 86a8 <big.0>
    124c:	00008697          	auipc	a3,0x8
    1250:	45c68693          	add	a3,a3,1116 # 96a8 <__global_pointer$+0x910>
      big[i] = 'x';
    ...
    1266:	44078323          	sb	zero,1094(a5) # 96a8 <__global_pointer$+0x910>
    char *args2[] = { big, big, big, 0 };
    126a:	00007797          	auipc	a5,0x7
    126e:	ea678793          	add	a5,a5,-346 # 8110 <malloc+0x24ae>
    ...
    1292:	af250513          	add	a0,a0,-1294 # 5d80 <malloc+0x11e>
    ...
    12aa:	2da50513          	add	a0,a0,730 # 6580 <malloc+0x91e>
    12ae:	00005097          	auipc	ra,0x5
    12b2:	8fc080e7          	jalr	-1796(ra) # 5baa <printf>
      exit(1);
    12b6:	4505                	li	a0,1
    ...
    12ca:	23250513          	add	a0,a0,562 # 64f8 <malloc+0x896>
    12ce:	00005097          	auipc	ra,0x5
    12d2:	8dc080e7          	jalr	-1828(ra) # 5baa <printf>
    exit(1);
    12d6:	4505                	li	a0,1
    ...
    12ea:	23250513          	add	a0,a0,562 # 6518 <malloc+0x8b6>
    12ee:	00005097          	auipc	ra,0x5
    12f2:	8bc080e7          	jalr	-1860(ra) # 5baa <printf>
    exit(1);
    12f6:	4505                	li	a0,1
    ...
    130c:	23050513          	add	a0,a0,560 # 6538 <malloc+0x8d6>
    1310:	00005097          	auipc	ra,0x5
    1314:	89a080e7          	jalr	-1894(ra) # 5baa <printf>
    exit(1);
    1318:	4505                	li	a0,1
    ...
    132c:	23850513          	add	a0,a0,568 # 6560 <malloc+0x8fe>
    1330:	00005097          	auipc	ra,0x5
    1334:	87a080e7          	jalr	-1926(ra) # 5baa <printf>
    exit(1);
    1338:	4505                	li	a0,1
    ...
    1346:	6b650513          	add	a0,a0,1718 # 69f8 <malloc+0xd96>
    134a:	00005097          	auipc	ra,0x5
    134e:	860080e7          	jalr	-1952(ra) # 5baa <printf>
    exit(1);
    1352:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1390:	21c50513          	add	a0,a0,540 # 65a8 <malloc+0x946>
    1394:	00005097          	auipc	ra,0x5
    1398:	816080e7          	jalr	-2026(ra) # 5baa <printf>
    exit(1);
    139c:	4505                	li	a0,1
...
00000000000013a6 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13c2:	a1a50513          	add	a0,a0,-1510 # 5dd8 <malloc+0x176>
  ...
  if(pid == 0){
    ...
    13ec:	9f0a0a13          	add	s4,s4,-1552 # 5dd8 <malloc+0x176>
      int n = write(fd, "1234567890", 10);
    13f0:	00005a97          	auipc	s5,0x5
    13f4:	218a8a93          	add	s5,s5,536 # 6608 <malloc+0x9a6>
      int fd = open("truncfile", O_WRONLY);
    13f8:	4585                	li	a1,1
    13fa:	8552                	mv	a0,s4
    ...
    1464:	17850513          	add	a0,a0,376 # 65d8 <malloc+0x976>
    1468:	00004097          	auipc	ra,0x4
    146c:	742080e7          	jalr	1858(ra) # 5baa <printf>
    exit(1);
    1470:	4505                	li	a0,1
    ...
    1480:	17450513          	add	a0,a0,372 # 65f0 <malloc+0x98e>
    1484:	00004097          	auipc	ra,0x4
    1488:	726080e7          	jalr	1830(ra) # 5baa <printf>
        exit(1);
    148c:	4505                	li	a0,1
    ...
    149e:	17e50513          	add	a0,a0,382 # 6618 <malloc+0x9b6>
    14a2:	00004097          	auipc	ra,0x4
    14a6:	708080e7          	jalr	1800(ra) # 5baa <printf>
        exit(1);
    14aa:	4505                	li	a0,1
    ...
    14bc:	920a0a13          	add	s4,s4,-1760 # 5dd8 <malloc+0x176>
    int n = write(fd, "xxx", 3);
    14c0:	00005a97          	auipc	s5,0x5
    14c4:	178a8a93          	add	s5,s5,376 # 6638 <malloc+0x9d6>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    150e:	8ce50513          	add	a0,a0,-1842 # 5dd8 <malloc+0x176>
  ...
  exit(xstatus);
    ...
    152c:	0c850513          	add	a0,a0,200 # 65f0 <malloc+0x98e>
    1530:	00004097          	auipc	ra,0x4
    1534:	67a080e7          	jalr	1658(ra) # 5baa <printf>
      exit(1);
    1538:	4505                	li	a0,1
    ...
    154a:	0fa50513          	add	a0,a0,250 # 6640 <malloc+0x9de>
    154e:	00004097          	auipc	ra,0x4
    1552:	65c080e7          	jalr	1628(ra) # 5baa <printf>
      exit(1);
    1556:	4505                	li	a0,1
...
0000000000001560 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1572:	81278793          	add	a5,a5,-2030 # 5d80 <malloc+0x11e>
    1576:	fcf43023          	sd	a5,-64(s0)
    157a:	00005797          	auipc	a5,0x5
    157e:	0e678793          	add	a5,a5,230 # 6660 <malloc+0x9fe>
    1582:	fcf43423          	sd	a5,-56(s0)
    1586:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    158a:	00005517          	auipc	a0,0x5
    158e:	0de50513          	add	a0,a0,222 # 6668 <malloc+0xa06>
  ...
  if(pid == 0) {
    ...
    15bc:	0b050513          	add	a0,a0,176 # 6668 <malloc+0xa06>
    ...
    15d8:	0b450513          	add	a0,a0,180 # 6688 <malloc+0xa26>
    15dc:	00004097          	auipc	ra,0x4
    15e0:	5ce080e7          	jalr	1486(ra) # 5baa <printf>
      exit(1);
    15e4:	4505                	li	a0,1
    ...
    15f4:	fe850513          	add	a0,a0,-24 # 65d8 <malloc+0x976>
    15f8:	00004097          	auipc	ra,0x4
    15fc:	5b2080e7          	jalr	1458(ra) # 5baa <printf>
     exit(1);
    1600:	4505                	li	a0,1
    ...
    1610:	06450513          	add	a0,a0,100 # 6670 <malloc+0xa0e>
    1614:	00004097          	auipc	ra,0x4
    1618:	596080e7          	jalr	1430(ra) # 5baa <printf>
      exit(1);
    161c:	4505                	li	a0,1
    ...
    162e:	75650513          	add	a0,a0,1878 # 5d80 <malloc+0x11e>
  ...
  if(xstatus != 0)
    ...
    1662:	03a50513          	add	a0,a0,58 # 6698 <malloc+0xa36>
    1666:	00004097          	auipc	ra,0x4
    166a:	544080e7          	jalr	1348(ra) # 5baa <printf>
      exit(1);
    166e:	4505                	li	a0,1
    ...
    167e:	03650513          	add	a0,a0,54 # 66b0 <malloc+0xa4e>
    1682:	00004097          	auipc	ra,0x4
    1686:	528080e7          	jalr	1320(ra) # 5baa <printf>
    168a:	b7d1                	j	164e <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    168c:	4581                	li	a1,0
    168e:	00005517          	auipc	a0,0x5
    1692:	fda50513          	add	a0,a0,-38 # 6668 <malloc+0xa06>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16bc:	a6850513          	add	a0,a0,-1432 # 6120 <malloc+0x4be>
    16c0:	00004097          	auipc	ra,0x4
    16c4:	4ea080e7          	jalr	1258(ra) # 5baa <printf>
    exit(1);
    16c8:	4505                	li	a0,1
    ...
    16d8:	f1c50513          	add	a0,a0,-228 # 65f0 <malloc+0x98e>
  ...
  unlink("echo-ok");
    ...
    16f2:	f7a50513          	add	a0,a0,-134 # 6668 <malloc+0xa06>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    171c:	fb050513          	add	a0,a0,-80 # 66c8 <malloc+0xa66>
    1720:	00004097          	auipc	ra,0x4
    1724:	48a080e7          	jalr	1162(ra) # 5baa <printf>
    exit(1);
    1728:	4505                	li	a0,1
...
000000000000173c <pipe1>:
{
  ...
  if(pid == 0){
    ...
    1788:	63ca8a93          	add	s5,s5,1596 # bdc0 <buf>
    178c:	864e                	mv	a2,s3
    178e:	85d6                	mv	a1,s5
    ...
    17a4:	62070713          	add	a4,a4,1568 # bdc0 <buf>
    ...
    17dc:	f0850513          	add	a0,a0,-248 # 66e0 <malloc+0xa7e>
    17e0:	00004097          	auipc	ra,0x4
    17e4:	3ca080e7          	jalr	970(ra) # 5baa <printf>
    exit(1);
    17e8:	4505                	li	a0,1
    ...
    1802:	5c2b0b13          	add	s6,s6,1474 # bdc0 <buf>
    ...
    1816:	42da8a93          	add	s5,s5,1069 # 142d <truncate3+0x87>
{
    ...
    1862:	e9a50513          	add	a0,a0,-358 # 66f8 <malloc+0xa96>
    1866:	00004097          	auipc	ra,0x4
    186a:	344080e7          	jalr	836(ra) # 5baa <printf>
        exit(1);
    186e:	4505                	li	a0,1
    ...
    187e:	e9650513          	add	a0,a0,-362 # 6710 <malloc+0xaae>
    1882:	00004097          	auipc	ra,0x4
    1886:	328080e7          	jalr	808(ra) # 5baa <printf>
}
    ...
    18b0:	e7c50513          	add	a0,a0,-388 # 6728 <malloc+0xac6>
    18b4:	00004097          	auipc	ra,0x4
    18b8:	2f6080e7          	jalr	758(ra) # 5baa <printf>
      exit(1);
    18bc:	4505                	li	a0,1
    ...
    18f0:	e5c50513          	add	a0,a0,-420 # 6748 <malloc+0xae6>
    18f4:	00004097          	auipc	ra,0x4
    18f8:	2b6080e7          	jalr	694(ra) # 5baa <printf>
    exit(1);
    18fc:	4505                	li	a0,1
...
0000000000001906 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1962:	c7a50513          	add	a0,a0,-902 # 65d8 <malloc+0x976>
    1966:	00004097          	auipc	ra,0x4
    196a:	244080e7          	jalr	580(ra) # 5baa <printf>
      exit(1);
    196e:	4505                	li	a0,1
    ...
    197e:	de650513          	add	a0,a0,-538 # 6760 <malloc+0xafe>
    1982:	00004097          	auipc	ra,0x4
    1986:	228080e7          	jalr	552(ra) # 5baa <printf>
        exit(1);
    198a:	4505                	li	a0,1
    ...
    199a:	de250513          	add	a0,a0,-542 # 6778 <malloc+0xb16>
    199e:	00004097          	auipc	ra,0x4
    19a2:	20c080e7          	jalr	524(ra) # 5baa <printf>
        exit(1);
    19a6:	4505                	li	a0,1
...
00000000000019ba <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a12:	bca50513          	add	a0,a0,-1078 # 65d8 <malloc+0x976>
    1a16:	00004097          	auipc	ra,0x4
    1a1a:	194080e7          	jalr	404(ra) # 5baa <printf>
      exit(1);
    1a1e:	4505                	li	a0,1
    ...
    1a36:	ba650513          	add	a0,a0,-1114 # 65d8 <malloc+0x976>
    1a3a:	00004097          	auipc	ra,0x4
    1a3e:	170080e7          	jalr	368(ra) # 5baa <printf>
        exit(1);
    1a42:	4505                	li	a0,1
...
0000000000001a54 <forkfork>:
{
    ...
    1ab0:	cec50513          	add	a0,a0,-788 # 6798 <malloc+0xb36>
    1ab4:	00004097          	auipc	ra,0x4
    1ab8:	0f6080e7          	jalr	246(ra) # 5baa <printf>
      exit(1);
    1abc:	4505                	li	a0,1
    ...
    1ac2:	d74080e7          	jalr	-652(ra) # 5832 <exit>
{
    ...
    1b08:	ca450513          	add	a0,a0,-860 # 67a8 <malloc+0xb46>
    1b0c:	00004097          	auipc	ra,0x4
    1b10:	09e080e7          	jalr	158(ra) # 5baa <printf>
      exit(1);
    1b14:	4505                	li	a0,1
...
0000000000001b1e <reparent2>:
{
  ...
  exit(0);
    ...
    1b56:	ea650513          	add	a0,a0,-346 # 69f8 <malloc+0xd96>
    1b5a:	00004097          	auipc	ra,0x4
    1b5e:	050080e7          	jalr	80(ra) # 5baa <printf>
      exit(1);
    1b62:	4505                	li	a0,1
...
0000000000001b86 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1bf4:	e0850513          	add	a0,a0,-504 # 69f8 <malloc+0xd96>
    1bf8:	00004097          	auipc	ra,0x4
    1bfc:	fb2080e7          	jalr	-78(ra) # 5baa <printf>
      exit(1);
    1c00:	4505                	li	a0,1
    ...
    1c20:	a5450513          	add	a0,a0,-1452 # 6670 <malloc+0xa0e>
    1c24:	00004097          	auipc	ra,0x4
    1c28:	f86080e7          	jalr	-122(ra) # 5baa <printf>
          exit(1);
    1c2c:	4505                	li	a0,1
    ...
    1c92:	b3a50513          	add	a0,a0,-1222 # 67c8 <malloc+0xb66>
    1c96:	00004097          	auipc	ra,0x4
    1c9a:	f14080e7          	jalr	-236(ra) # 5baa <printf>
            exit(1);
    1c9e:	4505                	li	a0,1
    ...
    1cc6:	b1e50513          	add	a0,a0,-1250 # 67e0 <malloc+0xb7e>
    1cca:	00004097          	auipc	ra,0x4
    1cce:	ee0080e7          	jalr	-288(ra) # 5baa <printf>
        exit(1);
    1cd2:	4505                	li	a0,1
    ...
    1d2c:	ae050513          	add	a0,a0,-1312 # 6808 <malloc+0xba6>
    1d30:	00004097          	auipc	ra,0x4
    1d34:	e7a080e7          	jalr	-390(ra) # 5baa <printf>
        exit(1);
    1d38:	4505                	li	a0,1
...
0000000000001dac <linkunlink>:
{
  ...
  unlink("x");
    ...
    1dcc:	02850513          	add	a0,a0,40 # 5df0 <malloc+0x18e>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1df6:	e6d9899b          	addw	s3,s3,-403 # 41c64e6d <__BSS_END__+0x41c5609d>
    ...
    1e08:	feca8a93          	add	s5,s5,-20 # 5df0 <malloc+0x18e>
      link("cat", "x");
    1e0c:	00005b97          	auipc	s7,0x5
    1e10:	a24b8b93          	add	s7,s7,-1500 # 6830 <malloc+0xbce>
    1e14:	a825                	j	1e4c <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1e16:	85a6                	mv	a1,s1
    1e18:	00004517          	auipc	a0,0x4
    1e1c:	7c050513          	add	a0,a0,1984 # 65d8 <malloc+0x976>
    1e20:	00004097          	auipc	ra,0x4
    1e24:	d8a080e7          	jalr	-630(ra) # 5baa <printf>
    exit(1);
    1e28:	4505                	li	a0,1
...
0000000000001eae <manywrites>:
{
  ...
  exit(0);
    ...
    1f0a:	af250513          	add	a0,a0,-1294 # 69f8 <malloc+0xd96>
    1f0e:	00004097          	auipc	ra,0x4
    1f12:	c9c080e7          	jalr	-868(ra) # 5baa <printf>
      exit(1);
    1f16:	4505                	li	a0,1
    ...
    1f46:	e7eb0b13          	add	s6,s6,-386 # bdc0 <buf>
    ...
    1fba:	88250513          	add	a0,a0,-1918 # 6838 <malloc+0xbd6>
    1fbe:	00004097          	auipc	ra,0x4
    1fc2:	bec080e7          	jalr	-1044(ra) # 5baa <printf>
            exit(1);
    1fc6:	4505                	li	a0,1
    ...
    1fda:	e7a50513          	add	a0,a0,-390 # 5e50 <malloc+0x1ee>
    1fde:	00004097          	auipc	ra,0x4
    1fe2:	bcc080e7          	jalr	-1076(ra) # 5baa <printf>
            exit(1);
    1fe6:	4505                	li	a0,1
...
0000000000001ff8 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    2028:	84450513          	add	a0,a0,-1980 # 6868 <malloc+0xc06>
    202c:	00004097          	auipc	ra,0x4
    2030:	b7e080e7          	jalr	-1154(ra) # 5baa <printf>
    exit(1);
    2034:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    208a:	7ca50513          	add	a0,a0,1994 # 6850 <malloc+0xbee>
    208e:	00004097          	auipc	ra,0x4
    2092:	b1c080e7          	jalr	-1252(ra) # 5baa <printf>
    exit(1);
    2096:	4505                	li	a0,1
    ...
    20a6:	7ee50513          	add	a0,a0,2030 # 6890 <malloc+0xc2e>
    20aa:	00004097          	auipc	ra,0x4
    20ae:	b00080e7          	jalr	-1280(ra) # 5baa <printf>
      exit(1);
    20b2:	4505                	li	a0,1
    ...
    20c2:	7ea50513          	add	a0,a0,2026 # 68a8 <malloc+0xc46>
    20c6:	00004097          	auipc	ra,0x4
    20ca:	ae4080e7          	jalr	-1308(ra) # 5baa <printf>
    exit(1);
    20ce:	4505                	li	a0,1
...
00000000000020d8 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    20f4:	35098993          	add	s3,s3,848 # c350 <buf+0x590>
    20f8:	1003d937          	lui	s2,0x1003d
    20fc:	090e                	sll	s2,s2,0x3
    20fe:	48090913          	add	s2,s2,1152 # 1003d480 <__BSS_END__+0x1002e6b0>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2142:	49a50513          	add	a0,a0,1178 # 65d8 <malloc+0x976>
    2146:	00004097          	auipc	ra,0x4
    214a:	a64080e7          	jalr	-1436(ra) # 5baa <printf>
      exit(1);
    214e:	4505                	li	a0,1
    ...
    2164:	76050513          	add	a0,a0,1888 # 68c0 <malloc+0xc5e>
    2168:	00004097          	auipc	ra,0x4
    216c:	a42080e7          	jalr	-1470(ra) # 5baa <printf>
      exit(1);
    2170:	4505                	li	a0,1
...
0000000000002184 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    21e6:	3f650513          	add	a0,a0,1014 # 65d8 <malloc+0x976>
    21ea:	00004097          	auipc	ra,0x4
    21ee:	9c0080e7          	jalr	-1600(ra) # 5baa <printf>
      exit(1);
    21f2:	4505                	li	a0,1
    ...
    2212:	6d250513          	add	a0,a0,1746 # 68e0 <malloc+0xc7e>
    2216:	00004097          	auipc	ra,0x4
    221a:	994080e7          	jalr	-1644(ra) # 5baa <printf>
      exit(1);
    221e:	4505                	li	a0,1
...
0000000000002232 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2242:	6ba50513          	add	a0,a0,1722 # 68f8 <malloc+0xc96>
  ...
  fd = open("bigarg-ok", 0);
    ...
    2274:	68850513          	add	a0,a0,1672 # 68f8 <malloc+0xc96>
  ...
  close(fd);
    ...
    229a:	31278793          	add	a5,a5,786 # 85a8 <args.1>
    229e:	00006697          	auipc	a3,0x6
    22a2:	40268693          	add	a3,a3,1026 # 86a0 <args.1+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    22a6:	00004717          	auipc	a4,0x4
    22aa:	66270713          	add	a4,a4,1634 # 6908 <malloc+0xca6>
    ...
    22fe:	6ee50513          	add	a0,a0,1774 # 69e8 <malloc+0xd86>
    2302:	00004097          	auipc	ra,0x4
    2306:	8a8080e7          	jalr	-1880(ra) # 5baa <printf>
    exit(1);
    230a:	4505                	li	a0,1
    ...
    2322:	6ea50513          	add	a0,a0,1770 # 6a08 <malloc+0xda6>
    2326:	00004097          	auipc	ra,0x4
    232a:	884080e7          	jalr	-1916(ra) # 5baa <printf>
    exit(1);
    232e:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2376:	0007c603          	lbu	a2,0(a5) # fffffffffffff000 <__BSS_END__+0xffffffffffff0230>
    237a:	85a6                	mv	a1,s1
    237c:	00004517          	auipc	a0,0x4
    2380:	6ac50513          	add	a0,a0,1708 # 6a28 <malloc+0xdc6>
    2384:	00004097          	auipc	ra,0x4
    2388:	826080e7          	jalr	-2010(ra) # 5baa <printf>
    exit(1);
    238c:	4505                	li	a0,1
    ...
    239c:	24050513          	add	a0,a0,576 # 65d8 <malloc+0x976>
    23a0:	00004097          	auipc	ra,0x4
    23a4:	80a080e7          	jalr	-2038(ra) # 5baa <printf>
    exit(1);
    23a8:	4505                	li	a0,1
...
00000000000023bc <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2436:	29e78793          	add	a5,a5,670 # 76d0 <malloc+0x1a6e>
  ...
  if(ret != -1){
    ...
    2478:	5dc50513          	add	a0,a0,1500 # 6a50 <malloc+0xdee>
    247c:	00003097          	auipc	ra,0x3
    2480:	72e080e7          	jalr	1838(ra) # 5baa <printf>
    exit(1);
    2484:	4505                	li	a0,1
    ...
    2496:	06650513          	add	a0,a0,102 # 64f8 <malloc+0x896>
    249a:	00003097          	auipc	ra,0x3
    249e:	710080e7          	jalr	1808(ra) # 5baa <printf>
    exit(1);
    24a2:	4505                	li	a0,1
    ...
    24b4:	06850513          	add	a0,a0,104 # 6518 <malloc+0x8b6>
    24b8:	00003097          	auipc	ra,0x3
    24bc:	6f2080e7          	jalr	1778(ra) # 5baa <printf>
    exit(1);
    24c0:	4505                	li	a0,1
    ...
    24d4:	06850513          	add	a0,a0,104 # 6538 <malloc+0x8d6>
    24d8:	00003097          	auipc	ra,0x3
    24dc:	6d2080e7          	jalr	1746(ra) # 5baa <printf>
    exit(1);
    24e0:	4505                	li	a0,1
    ...
    24f2:	07250513          	add	a0,a0,114 # 6560 <malloc+0x8fe>
    24f6:	00003097          	auipc	ra,0x3
    24fa:	6b4080e7          	jalr	1716(ra) # 5baa <printf>
    exit(1);
    24fe:	4505                	li	a0,1
...
0000000000002508 <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    253e:	55650513          	add	a0,a0,1366 # 6a90 <malloc+0xe2e>
  ...
  if(n >= 0){
    ...
    256e:	54650513          	add	a0,a0,1350 # 6ab0 <malloc+0xe4e>
    2572:	00003097          	auipc	ra,0x3
    2576:	638080e7          	jalr	1592(ra) # 5baa <printf>
    exit(1);
    257a:	4505                	li	a0,1
    ...
    2588:	4d450513          	add	a0,a0,1236 # 6a58 <malloc+0xdf6>
    258c:	00003097          	auipc	ra,0x3
    2590:	61e080e7          	jalr	1566(ra) # 5baa <printf>
    exit(1);
    2594:	4505                	li	a0,1
    ...
    25a2:	4d250513          	add	a0,a0,1234 # 6a70 <malloc+0xe0e>
    25a6:	00003097          	auipc	ra,0x3
    25aa:	604080e7          	jalr	1540(ra) # 5baa <printf>
    exit(1);
    25ae:	4505                	li	a0,1
    ...
    25bc:	4e050513          	add	a0,a0,1248 # 6a98 <malloc+0xe36>
    25c0:	00003097          	auipc	ra,0x3
    25c4:	5ea080e7          	jalr	1514(ra) # 5baa <printf>
    exit(1);
    25c8:	4505                	li	a0,1
  ...
  if(n >= 0){
    ...
    261c:	4c850513          	add	a0,a0,1224 # 6ae0 <malloc+0xe7e>
    2620:	00003097          	auipc	ra,0x3
    2624:	58a080e7          	jalr	1418(ra) # 5baa <printf>
    exit(1);
    2628:	4505                	li	a0,1
    ...
    2636:	46650513          	add	a0,a0,1126 # 6a98 <malloc+0xe36>
    263a:	00003097          	auipc	ra,0x3
    263e:	570080e7          	jalr	1392(ra) # 5baa <printf>
    exit(1);
    2642:	4505                	li	a0,1
...
0000000000002660 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    269c:	6705                	lui	a4,0x1
      *b = 99;
    269e:	00d50023          	sb	a3,0(a0) # 40000000 <__BSS_END__+0x3fff1230>
    for(b = a; b < a+TOOMUCH; b += 4096){
    ...
    26b6:	45650513          	add	a0,a0,1110 # 6b08 <malloc+0xea6>
    26ba:	00003097          	auipc	ra,0x3
    26be:	4f0080e7          	jalr	1264(ra) # 5baa <printf>
    exit(1);
    26c2:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2708:	42450513          	add	a0,a0,1060 # 6b28 <malloc+0xec6>
    270c:	00003097          	auipc	ra,0x3
    2710:	49e080e7          	jalr	1182(ra) # 5baa <printf>
    exit(1);
    2714:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    276c:	42050513          	add	a0,a0,1056 # 6b88 <malloc+0xf26>
    ...
    278e:	3be50513          	add	a0,a0,958 # 6b48 <malloc+0xee6>
    2792:	00003097          	auipc	ra,0x3
    2796:	418080e7          	jalr	1048(ra) # 5baa <printf>
      exit(1);
    279a:	4505                	li	a0,1
    ...
    27aa:	3c250513          	add	a0,a0,962 # 6b68 <malloc+0xf06>
    27ae:	00003097          	auipc	ra,0x3
    27b2:	3fc080e7          	jalr	1020(ra) # 5baa <printf>
    exit(1);
    27b6:	4505                	li	a0,1
...
00000000000027e6 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    2848:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63f122f>
  a = sbrk(0);
    284c:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    28ac:	fff7c703          	lbu	a4,-1(a5) # 63fffff <__BSS_END__+0x63f122f>
  ...
  if(c != a){
    ...
    28f4:	2b850513          	add	a0,a0,696 # 6ba8 <malloc+0xf46>
    28f8:	00003097          	auipc	ra,0x3
    28fc:	2b2080e7          	jalr	690(ra) # 5baa <printf>
    exit(1);
    2900:	4505                	li	a0,1
    ...
    2910:	2e450513          	add	a0,a0,740 # 6bf0 <malloc+0xf8e>
    2914:	00003097          	auipc	ra,0x3
    2918:	296080e7          	jalr	662(ra) # 5baa <printf>
    exit(1);
    291c:	4505                	li	a0,1
    ...
    2930:	2e450513          	add	a0,a0,740 # 6c10 <malloc+0xfae>
    2934:	00003097          	auipc	ra,0x3
    2938:	276080e7          	jalr	630(ra) # 5baa <printf>
    exit(1);
    293c:	4505                	li	a0,1
    ...
    2950:	30450513          	add	a0,a0,772 # 6c50 <malloc+0xfee>
    2954:	00003097          	auipc	ra,0x3
    2958:	256080e7          	jalr	598(ra) # 5baa <printf>
    exit(1);
    295c:	4505                	li	a0,1
    ...
    296c:	31850513          	add	a0,a0,792 # 6c80 <malloc+0x101e>
    2970:	00003097          	auipc	ra,0x3
    2974:	23a080e7          	jalr	570(ra) # 5baa <printf>
    exit(1);
    2978:	4505                	li	a0,1
    ...
    298c:	33050513          	add	a0,a0,816 # 6cb8 <malloc+0x1056>
    2990:	00003097          	auipc	ra,0x3
    2994:	21a080e7          	jalr	538(ra) # 5baa <printf>
    exit(1);
    2998:	4505                	li	a0,1
...
00000000000029a2 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    29c6:	31e50513          	add	a0,a0,798 # 6ce0 <malloc+0x107e>
    29ca:	00003097          	auipc	ra,0x3
    29ce:	ea8080e7          	jalr	-344(ra) # 5872 <open>
    29d2:	84aa                	mv	s1,a0
  unlink("sbrk");
    29d4:	00004517          	auipc	a0,0x4
    29d8:	30c50513          	add	a0,a0,780 # 6ce0 <malloc+0x107e>
  ...
  if(pipe((int *) a) != 0){
    ...
    2a2c:	2c050513          	add	a0,a0,704 # 6ce8 <malloc+0x1086>
    2a30:	00003097          	auipc	ra,0x3
    2a34:	17a080e7          	jalr	378(ra) # 5baa <printf>
    exit(1);
    2a38:	4505                	li	a0,1
    ...
    2a48:	2bc50513          	add	a0,a0,700 # 6d00 <malloc+0x109e>
    2a4c:	00003097          	auipc	ra,0x3
    2a50:	15e080e7          	jalr	350(ra) # 5baa <printf>
    exit(1);
    2a54:	4505                	li	a0,1
    ...
    2a64:	c8050513          	add	a0,a0,-896 # 66e0 <malloc+0xa7e>
    2a68:	00003097          	auipc	ra,0x3
    2a6c:	142080e7          	jalr	322(ra) # 5baa <printf>
    exit(1);
    2a70:	4505                	li	a0,1
...
0000000000002a7a <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2a8e:	28e50513          	add	a0,a0,654 # 6d18 <malloc+0x10b6>
  ...
  close(fd);
    ...
    2ad6:	b1e50513          	add	a0,a0,-1250 # 65f0 <malloc+0x98e>
    2ada:	00003097          	auipc	ra,0x3
    2ade:	0d0080e7          	jalr	208(ra) # 5baa <printf>
    exit(1);
    2ae2:	4505                	li	a0,1
...
0000000000002aec <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2b24:	ed850513          	add	a0,a0,-296 # 69f8 <malloc+0xd96>
    2b28:	00003097          	auipc	ra,0x3
    2b2c:	082080e7          	jalr	130(ra) # 5baa <printf>
    exit(1);
    2b30:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2b7a:	e8250513          	add	a0,a0,-382 # 69f8 <malloc+0xd96>
    2b7e:	00003097          	auipc	ra,0x3
    2b82:	02c080e7          	jalr	44(ra) # 5baa <printf>
    exit(1);
    2b86:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2bb2:	8007879b          	addw	a5,a5,-2048 # a800 <uninit+0x1150>
    ...
    2bda:	e2250513          	add	a0,a0,-478 # 69f8 <malloc+0xd96>
    2bde:	00003097          	auipc	ra,0x3
    2be2:	fcc080e7          	jalr	-52(ra) # 5baa <printf>
    exit(1);
    2be6:	4505                	li	a0,1
...
0000000000002cd6 <sbrk8000>:
{
  ...
  sbrk(0x80000004);
    ...
    2ce2:	0511                	add	a0,a0,4 # ffffffff80000004 <__BSS_END__+0xffffffff7fff1234>
...
execout(char *s)
{
  ...
  exit(0);
    ...
    2d4e:	cae50513          	add	a0,a0,-850 # 69f8 <malloc+0xd96>
    2d52:	00003097          	auipc	ra,0x3
    2d56:	e58080e7          	jalr	-424(ra) # 5baa <printf>
      exit(1);
    2d5a:	4505                	li	a0,1
    ...
    2da2:	fe250513          	add	a0,a0,-30 # 5d80 <malloc+0x11e>
    2da6:	faa43c23          	sd	a0,-72(s0)
    2daa:	00003797          	auipc	a5,0x3
    2dae:	04678793          	add	a5,a5,70 # 5df0 <malloc+0x18e>
...
0000000000002dd0 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2de0:	11450513          	add	a0,a0,276 # 6ef0 <malloc+0x128e>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2df2:	f5a50513          	add	a0,a0,-166 # 6d48 <malloc+0x10e6>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2e08:	f9c50513          	add	a0,a0,-100 # 6da0 <malloc+0x113e>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2e26:	ff650513          	add	a0,a0,-10 # 6e18 <malloc+0x11b6>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2e42:	04a50513          	add	a0,a0,74 # 6e88 <malloc+0x1226>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2e54:	09050513          	add	a0,a0,144 # 6ee0 <malloc+0x127e>
  ...
  unlink("12345678901234");
    ...
    2ed2:	e5250513          	add	a0,a0,-430 # 6d20 <malloc+0x10be>
    2ed6:	00003097          	auipc	ra,0x3
    2eda:	cd4080e7          	jalr	-812(ra) # 5baa <printf>
    exit(1);
    2ede:	4505                	li	a0,1
    ...
    2eee:	e7e50513          	add	a0,a0,-386 # 6d68 <malloc+0x1106>
    2ef2:	00003097          	auipc	ra,0x3
    2ef6:	cb8080e7          	jalr	-840(ra) # 5baa <printf>
    exit(1);
    2efa:	4505                	li	a0,1
    ...
    2f0a:	eca50513          	add	a0,a0,-310 # 6dd0 <malloc+0x116e>
    2f0e:	00003097          	auipc	ra,0x3
    2f12:	c9c080e7          	jalr	-868(ra) # 5baa <printf>
    exit(1);
    2f16:	4505                	li	a0,1
    ...
    2f26:	f2650513          	add	a0,a0,-218 # 6e48 <malloc+0x11e6>
    2f2a:	00003097          	auipc	ra,0x3
    2f2e:	c80080e7          	jalr	-896(ra) # 5baa <printf>
    exit(1);
    2f32:	4505                	li	a0,1
    ...
    2f42:	f6a50513          	add	a0,a0,-150 # 6ea8 <malloc+0x1246>
    2f46:	00003097          	auipc	ra,0x3
    2f4a:	c64080e7          	jalr	-924(ra) # 5baa <printf>
    exit(1);
    2f4e:	4505                	li	a0,1
    ...
    2f5e:	fa650513          	add	a0,a0,-90 # 6f00 <malloc+0x129e>
    2f62:	00003097          	auipc	ra,0x3
    2f66:	c48080e7          	jalr	-952(ra) # 5baa <printf>
    exit(1);
    2f6a:	4505                	li	a0,1
...
0000000000002f74 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2f84:	fb850513          	add	a0,a0,-72 # 6f38 <malloc+0x12d6>
  ...
  if(chdir("iputdir") < 0){
    ...
    2f98:	fa450513          	add	a0,a0,-92 # 6f38 <malloc+0x12d6>
  ...
  if(unlink("../iputdir") < 0){
    ...
    2fac:	fd050513          	add	a0,a0,-48 # 6f78 <malloc+0x1316>
  ...
  if(chdir("/") < 0){
    ...
    2fc0:	fec50513          	add	a0,a0,-20 # 6fa8 <malloc+0x1346>
    ...
    2fe0:	f6450513          	add	a0,a0,-156 # 6f40 <malloc+0x12de>
    2fe4:	00003097          	auipc	ra,0x3
    2fe8:	bc6080e7          	jalr	-1082(ra) # 5baa <printf>
    exit(1);
    2fec:	4505                	li	a0,1
    ...
    2ffc:	f6050513          	add	a0,a0,-160 # 6f58 <malloc+0x12f6>
    3000:	00003097          	auipc	ra,0x3
    3004:	baa080e7          	jalr	-1110(ra) # 5baa <printf>
    exit(1);
    3008:	4505                	li	a0,1
    ...
    3018:	f7450513          	add	a0,a0,-140 # 6f88 <malloc+0x1326>
    301c:	00003097          	auipc	ra,0x3
    3020:	b8e080e7          	jalr	-1138(ra) # 5baa <printf>
    exit(1);
    3024:	4505                	li	a0,1
    ...
    3034:	f8050513          	add	a0,a0,-128 # 6fb0 <malloc+0x134e>
    3038:	00003097          	auipc	ra,0x3
    303c:	b72080e7          	jalr	-1166(ra) # 5baa <printf>
    exit(1);
    3040:	4505                	li	a0,1
...
000000000000304a <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    3068:	ed450513          	add	a0,a0,-300 # 6f38 <malloc+0x12d6>
    ...
    307c:	ec050513          	add	a0,a0,-320 # 6f38 <malloc+0x12d6>
    ...
    3090:	eec50513          	add	a0,a0,-276 # 6f78 <malloc+0x1316>
    ...
    30b0:	52c50513          	add	a0,a0,1324 # 65d8 <malloc+0x976>
    30b4:	00003097          	auipc	ra,0x3
    30b8:	af6080e7          	jalr	-1290(ra) # 5baa <printf>
    exit(1);
    30bc:	4505                	li	a0,1
    ...
    30cc:	e7850513          	add	a0,a0,-392 # 6f40 <malloc+0x12de>
    30d0:	00003097          	auipc	ra,0x3
    30d4:	ada080e7          	jalr	-1318(ra) # 5baa <printf>
      exit(1);
    30d8:	4505                	li	a0,1
    ...
    30e8:	ee450513          	add	a0,a0,-284 # 6fc8 <malloc+0x1366>
    30ec:	00003097          	auipc	ra,0x3
    30f0:	abe080e7          	jalr	-1346(ra) # 5baa <printf>
      exit(1);
    30f4:	4505                	li	a0,1
    ...
    3104:	e8850513          	add	a0,a0,-376 # 6f88 <malloc+0x1326>
    3108:	00003097          	auipc	ra,0x3
    310c:	aa2080e7          	jalr	-1374(ra) # 5baa <printf>
      exit(1);
    3110:	4505                	li	a0,1
...
0000000000003132 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    3142:	ea250513          	add	a0,a0,-350 # 6fe0 <malloc+0x137e>
  ...
  if(chdir("dir0") < 0){
    ...
    3156:	e8e50513          	add	a0,a0,-370 # 6fe0 <malloc+0x137e>
  ...
  if(chdir("..") < 0){
    ...
    316a:	e9a50513          	add	a0,a0,-358 # 7000 <malloc+0x139e>
  ...
  if(unlink("dir0") < 0){
    ...
    317e:	e6650513          	add	a0,a0,-410 # 6fe0 <malloc+0x137e>
    ...
    319e:	da650513          	add	a0,a0,-602 # 6f40 <malloc+0x12de>
    31a2:	00003097          	auipc	ra,0x3
    31a6:	a08080e7          	jalr	-1528(ra) # 5baa <printf>
    exit(1);
    31aa:	4505                	li	a0,1
    ...
    31ba:	e3250513          	add	a0,a0,-462 # 6fe8 <malloc+0x1386>
    31be:	00003097          	auipc	ra,0x3
    31c2:	9ec080e7          	jalr	-1556(ra) # 5baa <printf>
    exit(1);
    31c6:	4505                	li	a0,1
    ...
    31d6:	e3650513          	add	a0,a0,-458 # 7008 <malloc+0x13a6>
    31da:	00003097          	auipc	ra,0x3
    31de:	9d0080e7          	jalr	-1584(ra) # 5baa <printf>
    exit(1);
    31e2:	4505                	li	a0,1
    ...
    31f2:	e3250513          	add	a0,a0,-462 # 7020 <malloc+0x13be>
    31f6:	00003097          	auipc	ra,0x3
    31fa:	9b4080e7          	jalr	-1612(ra) # 5baa <printf>
    exit(1);
    31fe:	4505                	li	a0,1
...
0000000000003208 <subdir>:
{
  ...
  unlink("ff");
    ...
    321a:	f5250513          	add	a0,a0,-174 # 7168 <malloc+0x1506>
    321e:	00002097          	auipc	ra,0x2
    3222:	664080e7          	jalr	1636(ra) # 5882 <unlink>
  if(mkdir("dd") != 0){
    3226:	00004517          	auipc	a0,0x4
    322a:	e1250513          	add	a0,a0,-494 # 7038 <malloc+0x13d6>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3242:	e1a50513          	add	a0,a0,-486 # 7058 <malloc+0x13f6>
  ...
  write(fd, "ff", 2);
    ...
    325a:	f1258593          	add	a1,a1,-238 # 7168 <malloc+0x1506>
  ...
  if(unlink("dd") >= 0){
    ...
    3274:	dc850513          	add	a0,a0,-568 # 7038 <malloc+0x13d6>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3288:	e2c50513          	add	a0,a0,-468 # 70b0 <malloc+0x144e>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    32a0:	e3c50513          	add	a0,a0,-452 # 70d8 <malloc+0x1476>
  ...
  write(fd, "FF", 2);
    ...
    32b8:	e5458593          	add	a1,a1,-428 # 7108 <malloc+0x14a6>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    32d4:	e4050513          	add	a0,a0,-448 # 7110 <malloc+0x14ae>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    32ec:	ad858593          	add	a1,a1,-1320 # bdc0 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    3302:	ac274703          	lbu	a4,-1342(a4) # bdc0 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    331c:	e4858593          	add	a1,a1,-440 # 7160 <malloc+0x14fe>
    3320:	00004517          	auipc	a0,0x4
    3324:	db850513          	add	a0,a0,-584 # 70d8 <malloc+0x1476>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3338:	da450513          	add	a0,a0,-604 # 70d8 <malloc+0x1476>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    334e:	d8e50513          	add	a0,a0,-626 # 70d8 <malloc+0x1476>
  ...
  if(chdir("dd") != 0){
    ...
    3362:	cda50513          	add	a0,a0,-806 # 7038 <malloc+0x13d6>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3376:	e8650513          	add	a0,a0,-378 # 71f8 <malloc+0x1596>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    338a:	ea250513          	add	a0,a0,-350 # 7228 <malloc+0x15c6>
  ...
  if(chdir("./..") != 0){
    ...
    339e:	ebe50513          	add	a0,a0,-322 # 7258 <malloc+0x15f6>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    33b4:	db050513          	add	a0,a0,-592 # 7160 <malloc+0x14fe>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    33cc:	9f858593          	add	a1,a1,-1544 # bdc0 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    33ee:	cee50513          	add	a0,a0,-786 # 70d8 <malloc+0x1476>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3406:	ee650513          	add	a0,a0,-282 # 72e8 <malloc+0x1686>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    341e:	efe50513          	add	a0,a0,-258 # 7318 <malloc+0x16b6>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    3436:	c0650513          	add	a0,a0,-1018 # 7038 <malloc+0x13d6>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    344c:	bf050513          	add	a0,a0,-1040 # 7038 <malloc+0x13d6>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    3462:	bda50513          	add	a0,a0,-1062 # 7038 <malloc+0x13d6>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    3476:	f3658593          	add	a1,a1,-202 # 73a8 <malloc+0x1746>
    347a:	00004517          	auipc	a0,0x4
    347e:	e6e50513          	add	a0,a0,-402 # 72e8 <malloc+0x1686>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3492:	f1a58593          	add	a1,a1,-230 # 73a8 <malloc+0x1746>
    3496:	00004517          	auipc	a0,0x4
    349a:	e8250513          	add	a0,a0,-382 # 7318 <malloc+0x16b6>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    34ae:	cb658593          	add	a1,a1,-842 # 7160 <malloc+0x14fe>
    34b2:	00004517          	auipc	a0,0x4
    34b6:	ba650513          	add	a0,a0,-1114 # 7058 <malloc+0x13f6>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    34ca:	e2250513          	add	a0,a0,-478 # 72e8 <malloc+0x1686>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    34de:	e3e50513          	add	a0,a0,-450 # 7318 <malloc+0x16b6>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    34f2:	c7250513          	add	a0,a0,-910 # 7160 <malloc+0x14fe>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3506:	e1650513          	add	a0,a0,-490 # 7318 <malloc+0x16b6>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    351a:	dd250513          	add	a0,a0,-558 # 72e8 <malloc+0x1686>
  ...
  if(chdir("dd/ff") == 0){
    ...
    352e:	b2e50513          	add	a0,a0,-1234 # 7058 <malloc+0x13f6>
  ...
  if(chdir("dd/xx") == 0){
    ...
    3542:	fba50513          	add	a0,a0,-70 # 74f8 <malloc+0x1896>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    3556:	c0e50513          	add	a0,a0,-1010 # 7160 <malloc+0x14fe>
  ...
  if(unlink("dd/ff") != 0){
    ...
    356a:	af250513          	add	a0,a0,-1294 # 7058 <malloc+0x13f6>
  ...
  if(unlink("dd") == 0){
    ...
    357e:	abe50513          	add	a0,a0,-1346 # 7038 <malloc+0x13d6>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3592:	fda50513          	add	a0,a0,-38 # 7568 <malloc+0x1906>
  ...
  if(unlink("dd") < 0){
    ...
    35a6:	a9650513          	add	a0,a0,-1386 # 7038 <malloc+0x13d6>
    ...
    35c8:	a7c50513          	add	a0,a0,-1412 # 7040 <malloc+0x13de>
    35cc:	00002097          	auipc	ra,0x2
    35d0:	5de080e7          	jalr	1502(ra) # 5baa <printf>
    exit(1);
    35d4:	4505                	li	a0,1
    ...
    35e4:	a8050513          	add	a0,a0,-1408 # 7060 <malloc+0x13fe>
    35e8:	00002097          	auipc	ra,0x2
    35ec:	5c2080e7          	jalr	1474(ra) # 5baa <printf>
    exit(1);
    35f0:	4505                	li	a0,1
    ...
    3600:	a8450513          	add	a0,a0,-1404 # 7080 <malloc+0x141e>
    3604:	00002097          	auipc	ra,0x2
    3608:	5a6080e7          	jalr	1446(ra) # 5baa <printf>
    exit(1);
    360c:	4505                	li	a0,1
    ...
    361c:	aa050513          	add	a0,a0,-1376 # 70b8 <malloc+0x1456>
    3620:	00002097          	auipc	ra,0x2
    3624:	58a080e7          	jalr	1418(ra) # 5baa <printf>
    exit(1);
    3628:	4505                	li	a0,1
    ...
    3638:	ab450513          	add	a0,a0,-1356 # 70e8 <malloc+0x1486>
    363c:	00002097          	auipc	ra,0x2
    3640:	56e080e7          	jalr	1390(ra) # 5baa <printf>
    exit(1);
    3644:	4505                	li	a0,1
    ...
    3654:	ad050513          	add	a0,a0,-1328 # 7120 <malloc+0x14be>
    3658:	00002097          	auipc	ra,0x2
    365c:	552080e7          	jalr	1362(ra) # 5baa <printf>
    exit(1);
    3660:	4505                	li	a0,1
    ...
    3670:	ad450513          	add	a0,a0,-1324 # 7140 <malloc+0x14de>
    3674:	00002097          	auipc	ra,0x2
    3678:	536080e7          	jalr	1334(ra) # 5baa <printf>
    exit(1);
    367c:	4505                	li	a0,1
    ...
    368c:	ae850513          	add	a0,a0,-1304 # 7170 <malloc+0x150e>
    3690:	00002097          	auipc	ra,0x2
    3694:	51a080e7          	jalr	1306(ra) # 5baa <printf>
    exit(1);
    3698:	4505                	li	a0,1
    ...
    36a8:	af450513          	add	a0,a0,-1292 # 7198 <malloc+0x1536>
    36ac:	00002097          	auipc	ra,0x2
    36b0:	4fe080e7          	jalr	1278(ra) # 5baa <printf>
    exit(1);
    36b4:	4505                	li	a0,1
    ...
    36c4:	af850513          	add	a0,a0,-1288 # 71b8 <malloc+0x1556>
    36c8:	00002097          	auipc	ra,0x2
    36cc:	4e2080e7          	jalr	1250(ra) # 5baa <printf>
    exit(1);
    36d0:	4505                	li	a0,1
    ...
    36e0:	b0450513          	add	a0,a0,-1276 # 71e0 <malloc+0x157e>
    36e4:	00002097          	auipc	ra,0x2
    36e8:	4c6080e7          	jalr	1222(ra) # 5baa <printf>
    exit(1);
    36ec:	4505                	li	a0,1
    ...
    36fc:	b1050513          	add	a0,a0,-1264 # 7208 <malloc+0x15a6>
    3700:	00002097          	auipc	ra,0x2
    3704:	4aa080e7          	jalr	1194(ra) # 5baa <printf>
    exit(1);
    3708:	4505                	li	a0,1
    ...
    3718:	b2450513          	add	a0,a0,-1244 # 7238 <malloc+0x15d6>
    371c:	00002097          	auipc	ra,0x2
    3720:	48e080e7          	jalr	1166(ra) # 5baa <printf>
    exit(1);
    3724:	4505                	li	a0,1
    ...
    3734:	b3050513          	add	a0,a0,-1232 # 7260 <malloc+0x15fe>
    3738:	00002097          	auipc	ra,0x2
    373c:	472080e7          	jalr	1138(ra) # 5baa <printf>
    exit(1);
    3740:	4505                	li	a0,1
    ...
    3750:	b2c50513          	add	a0,a0,-1236 # 7278 <malloc+0x1616>
    3754:	00002097          	auipc	ra,0x2
    3758:	456080e7          	jalr	1110(ra) # 5baa <printf>
    exit(1);
    375c:	4505                	li	a0,1
    ...
    376c:	b3050513          	add	a0,a0,-1232 # 7298 <malloc+0x1636>
    3770:	00002097          	auipc	ra,0x2
    3774:	43a080e7          	jalr	1082(ra) # 5baa <printf>
    exit(1);
    3778:	4505                	li	a0,1
    ...
    3788:	b3450513          	add	a0,a0,-1228 # 72b8 <malloc+0x1656>
    378c:	00002097          	auipc	ra,0x2
    3790:	41e080e7          	jalr	1054(ra) # 5baa <printf>
    exit(1);
    3794:	4505                	li	a0,1
    ...
    37a4:	b5850513          	add	a0,a0,-1192 # 72f8 <malloc+0x1696>
    37a8:	00002097          	auipc	ra,0x2
    37ac:	402080e7          	jalr	1026(ra) # 5baa <printf>
    exit(1);
    37b0:	4505                	li	a0,1
    ...
    37c0:	b6c50513          	add	a0,a0,-1172 # 7328 <malloc+0x16c6>
    37c4:	00002097          	auipc	ra,0x2
    37c8:	3e6080e7          	jalr	998(ra) # 5baa <printf>
    exit(1);
    37cc:	4505                	li	a0,1
    ...
    37dc:	b7050513          	add	a0,a0,-1168 # 7348 <malloc+0x16e6>
    37e0:	00002097          	auipc	ra,0x2
    37e4:	3ca080e7          	jalr	970(ra) # 5baa <printf>
    exit(1);
    37e8:	4505                	li	a0,1
    ...
    37f8:	b7450513          	add	a0,a0,-1164 # 7368 <malloc+0x1706>
    37fc:	00002097          	auipc	ra,0x2
    3800:	3ae080e7          	jalr	942(ra) # 5baa <printf>
    exit(1);
    3804:	4505                	li	a0,1
    ...
    3814:	b7850513          	add	a0,a0,-1160 # 7388 <malloc+0x1726>
    3818:	00002097          	auipc	ra,0x2
    381c:	392080e7          	jalr	914(ra) # 5baa <printf>
    exit(1);
    3820:	4505                	li	a0,1
    ...
    3830:	b8c50513          	add	a0,a0,-1140 # 73b8 <malloc+0x1756>
    3834:	00002097          	auipc	ra,0x2
    3838:	376080e7          	jalr	886(ra) # 5baa <printf>
    exit(1);
    383c:	4505                	li	a0,1
    ...
    384c:	b9850513          	add	a0,a0,-1128 # 73e0 <malloc+0x177e>
    3850:	00002097          	auipc	ra,0x2
    3854:	35a080e7          	jalr	858(ra) # 5baa <printf>
    exit(1);
    3858:	4505                	li	a0,1
    ...
    3868:	ba450513          	add	a0,a0,-1116 # 7408 <malloc+0x17a6>
    386c:	00002097          	auipc	ra,0x2
    3870:	33e080e7          	jalr	830(ra) # 5baa <printf>
    exit(1);
    3874:	4505                	li	a0,1
    ...
    3884:	bb050513          	add	a0,a0,-1104 # 7430 <malloc+0x17ce>
    3888:	00002097          	auipc	ra,0x2
    388c:	322080e7          	jalr	802(ra) # 5baa <printf>
    exit(1);
    3890:	4505                	li	a0,1
    ...
    38a0:	bb450513          	add	a0,a0,-1100 # 7450 <malloc+0x17ee>
    38a4:	00002097          	auipc	ra,0x2
    38a8:	306080e7          	jalr	774(ra) # 5baa <printf>
    exit(1);
    38ac:	4505                	li	a0,1
    ...
    38bc:	bb850513          	add	a0,a0,-1096 # 7470 <malloc+0x180e>
    38c0:	00002097          	auipc	ra,0x2
    38c4:	2ea080e7          	jalr	746(ra) # 5baa <printf>
    exit(1);
    38c8:	4505                	li	a0,1
    ...
    38d8:	bc450513          	add	a0,a0,-1084 # 7498 <malloc+0x1836>
    38dc:	00002097          	auipc	ra,0x2
    38e0:	2ce080e7          	jalr	718(ra) # 5baa <printf>
    exit(1);
    38e4:	4505                	li	a0,1
    ...
    38f4:	bc850513          	add	a0,a0,-1080 # 74b8 <malloc+0x1856>
    38f8:	00002097          	auipc	ra,0x2
    38fc:	2b2080e7          	jalr	690(ra) # 5baa <printf>
    exit(1);
    3900:	4505                	li	a0,1
    ...
    3910:	bcc50513          	add	a0,a0,-1076 # 74d8 <malloc+0x1876>
    3914:	00002097          	auipc	ra,0x2
    3918:	296080e7          	jalr	662(ra) # 5baa <printf>
    exit(1);
    391c:	4505                	li	a0,1
    ...
    392c:	bd850513          	add	a0,a0,-1064 # 7500 <malloc+0x189e>
    3930:	00002097          	auipc	ra,0x2
    3934:	27a080e7          	jalr	634(ra) # 5baa <printf>
    exit(1);
    3938:	4505                	li	a0,1
    ...
    3948:	85450513          	add	a0,a0,-1964 # 7198 <malloc+0x1536>
    394c:	00002097          	auipc	ra,0x2
    3950:	25e080e7          	jalr	606(ra) # 5baa <printf>
    exit(1);
    3954:	4505                	li	a0,1
    ...
    3964:	bc050513          	add	a0,a0,-1088 # 7520 <malloc+0x18be>
    3968:	00002097          	auipc	ra,0x2
    396c:	242080e7          	jalr	578(ra) # 5baa <printf>
    exit(1);
    3970:	4505                	li	a0,1
    ...
    3980:	bc450513          	add	a0,a0,-1084 # 7540 <malloc+0x18de>
    3984:	00002097          	auipc	ra,0x2
    3988:	226080e7          	jalr	550(ra) # 5baa <printf>
    exit(1);
    398c:	4505                	li	a0,1
    ...
    399c:	bd850513          	add	a0,a0,-1064 # 7570 <malloc+0x190e>
    39a0:	00002097          	auipc	ra,0x2
    39a4:	20a080e7          	jalr	522(ra) # 5baa <printf>
    exit(1);
    39a8:	4505                	li	a0,1
    ...
    39b8:	bdc50513          	add	a0,a0,-1060 # 7590 <malloc+0x192e>
    39bc:	00002097          	auipc	ra,0x2
    39c0:	1ee080e7          	jalr	494(ra) # 5baa <printf>
    exit(1);
    39c4:	4505                	li	a0,1
...
00000000000039ce <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    39de:	bce50513          	add	a0,a0,-1074 # 75a8 <malloc+0x1946>
  ...
  if(chdir("dots") != 0){
    ...
    39f0:	bbc50513          	add	a0,a0,-1092 # 75a8 <malloc+0x1946>
  ...
  if(unlink(".") == 0){
    ...
    3a02:	a3a50513          	add	a0,a0,-1478 # 6438 <malloc+0x7d6>
  ...
  if(unlink("..") == 0){
    ...
    3a14:	5f050513          	add	a0,a0,1520 # 7000 <malloc+0x139e>
  ...
  if(chdir("/") != 0){
    ...
    3a26:	58650513          	add	a0,a0,1414 # 6fa8 <malloc+0x1346>
  ...
  if(unlink("dots/.") == 0){
    ...
    3a38:	bdc50513          	add	a0,a0,-1060 # 7610 <malloc+0x19ae>
  ...
  if(unlink("dots/..") == 0){
    ...
    3a4a:	bf250513          	add	a0,a0,-1038 # 7638 <malloc+0x19d6>
  ...
  if(unlink("dots") != 0){
    ...
    3a5c:	b5050513          	add	a0,a0,-1200 # 75a8 <malloc+0x1946>
    ...
    3a7a:	b3a50513          	add	a0,a0,-1222 # 75b0 <malloc+0x194e>
    3a7e:	00002097          	auipc	ra,0x2
    3a82:	12c080e7          	jalr	300(ra) # 5baa <printf>
    exit(1);
    3a86:	4505                	li	a0,1
    ...
    3a96:	b3650513          	add	a0,a0,-1226 # 75c8 <malloc+0x1966>
    3a9a:	00002097          	auipc	ra,0x2
    3a9e:	110080e7          	jalr	272(ra) # 5baa <printf>
    exit(1);
    3aa2:	4505                	li	a0,1
    ...
    3ab2:	b3250513          	add	a0,a0,-1230 # 75e0 <malloc+0x197e>
    3ab6:	00002097          	auipc	ra,0x2
    3aba:	0f4080e7          	jalr	244(ra) # 5baa <printf>
    exit(1);
    3abe:	4505                	li	a0,1
    ...
    3ace:	b2e50513          	add	a0,a0,-1234 # 75f8 <malloc+0x1996>
    3ad2:	00002097          	auipc	ra,0x2
    3ad6:	0d8080e7          	jalr	216(ra) # 5baa <printf>
    exit(1);
    3ada:	4505                	li	a0,1
    ...
    3aea:	4ca50513          	add	a0,a0,1226 # 6fb0 <malloc+0x134e>
    3aee:	00002097          	auipc	ra,0x2
    3af2:	0bc080e7          	jalr	188(ra) # 5baa <printf>
    exit(1);
    3af6:	4505                	li	a0,1
    ...
    3b06:	b1650513          	add	a0,a0,-1258 # 7618 <malloc+0x19b6>
    3b0a:	00002097          	auipc	ra,0x2
    3b0e:	0a0080e7          	jalr	160(ra) # 5baa <printf>
    exit(1);
    3b12:	4505                	li	a0,1
    ...
    3b22:	b2250513          	add	a0,a0,-1246 # 7640 <malloc+0x19de>
    3b26:	00002097          	auipc	ra,0x2
    3b2a:	084080e7          	jalr	132(ra) # 5baa <printf>
    exit(1);
    3b2e:	4505                	li	a0,1
    ...
    3b3e:	b2650513          	add	a0,a0,-1242 # 7660 <malloc+0x19fe>
    3b42:	00002097          	auipc	ra,0x2
    3b46:	068080e7          	jalr	104(ra) # 5baa <printf>
    exit(1);
    3b4a:	4505                	li	a0,1
...
0000000000003b54 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3b6a:	b1a50513          	add	a0,a0,-1254 # 7680 <malloc+0x1a1e>
  ...
  if(chdir("dirfile") == 0){
    ...
    3b86:	afe50513          	add	a0,a0,-1282 # 7680 <malloc+0x1a1e>
  ...
  fd = open("dirfile/xx", 0);
    ...
    3b9a:	b3250513          	add	a0,a0,-1230 # 76c8 <malloc+0x1a66>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3bb2:	b1a50513          	add	a0,a0,-1254 # 76c8 <malloc+0x1a66>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3bc6:	b0650513          	add	a0,a0,-1274 # 76c8 <malloc+0x1a66>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3bda:	af250513          	add	a0,a0,-1294 # 76c8 <malloc+0x1a66>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3bee:	ade58593          	add	a1,a1,-1314 # 76c8 <malloc+0x1a66>
    3bf2:	00002517          	auipc	a0,0x2
    3bf6:	33650513          	add	a0,a0,822 # 5f28 <malloc+0x2c6>
  ...
  if(unlink("dirfile") != 0){
    ...
    3c0a:	a7a50513          	add	a0,a0,-1414 # 7680 <malloc+0x1a1e>
  ...
  fd = open(".", O_RDWR);
    ...
    3c20:	81c50513          	add	a0,a0,-2020 # 6438 <malloc+0x7d6>
  ...
  fd = open(".", 0);
    ...
    3c36:	80650513          	add	a0,a0,-2042 # 6438 <malloc+0x7d6>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3c4a:	1aa58593          	add	a1,a1,426 # 5df0 <malloc+0x18e>
  ...
  close(fd);
    ...
    3c76:	a1650513          	add	a0,a0,-1514 # 7688 <malloc+0x1a26>
    3c7a:	00002097          	auipc	ra,0x2
    3c7e:	f30080e7          	jalr	-208(ra) # 5baa <printf>
    exit(1);
    3c82:	4505                	li	a0,1
    ...
    3c92:	a1a50513          	add	a0,a0,-1510 # 76a8 <malloc+0x1a46>
    3c96:	00002097          	auipc	ra,0x2
    3c9a:	f14080e7          	jalr	-236(ra) # 5baa <printf>
    exit(1);
    3c9e:	4505                	li	a0,1
    ...
    3cae:	a2e50513          	add	a0,a0,-1490 # 76d8 <malloc+0x1a76>
    3cb2:	00002097          	auipc	ra,0x2
    3cb6:	ef8080e7          	jalr	-264(ra) # 5baa <printf>
    exit(1);
    3cba:	4505                	li	a0,1
    ...
    3cca:	a1250513          	add	a0,a0,-1518 # 76d8 <malloc+0x1a76>
    3cce:	00002097          	auipc	ra,0x2
    3cd2:	edc080e7          	jalr	-292(ra) # 5baa <printf>
    exit(1);
    3cd6:	4505                	li	a0,1
    ...
    3ce6:	a1e50513          	add	a0,a0,-1506 # 7700 <malloc+0x1a9e>
    3cea:	00002097          	auipc	ra,0x2
    3cee:	ec0080e7          	jalr	-320(ra) # 5baa <printf>
    exit(1);
    3cf2:	4505                	li	a0,1
    ...
    3d02:	a2a50513          	add	a0,a0,-1494 # 7728 <malloc+0x1ac6>
    3d06:	00002097          	auipc	ra,0x2
    3d0a:	ea4080e7          	jalr	-348(ra) # 5baa <printf>
    exit(1);
    3d0e:	4505                	li	a0,1
    ...
    3d1e:	a3650513          	add	a0,a0,-1482 # 7750 <malloc+0x1aee>
    3d22:	00002097          	auipc	ra,0x2
    3d26:	e88080e7          	jalr	-376(ra) # 5baa <printf>
    exit(1);
    3d2a:	4505                	li	a0,1
    ...
    3d3a:	a4250513          	add	a0,a0,-1470 # 7778 <malloc+0x1b16>
    3d3e:	00002097          	auipc	ra,0x2
    3d42:	e6c080e7          	jalr	-404(ra) # 5baa <printf>
    exit(1);
    3d46:	4505                	li	a0,1
    ...
    3d56:	a4650513          	add	a0,a0,-1466 # 7798 <malloc+0x1b36>
    3d5a:	00002097          	auipc	ra,0x2
    3d5e:	e50080e7          	jalr	-432(ra) # 5baa <printf>
    exit(1);
    3d62:	4505                	li	a0,1
    ...
    3d72:	a5250513          	add	a0,a0,-1454 # 77c0 <malloc+0x1b5e>
    3d76:	00002097          	auipc	ra,0x2
    3d7a:	e34080e7          	jalr	-460(ra) # 5baa <printf>
    exit(1);
    3d7e:	4505                	li	a0,1
...
0000000000003d88 <iref>:
{
    ...
    3da6:	a36a0a13          	add	s4,s4,-1482 # 77d8 <malloc+0x1b76>
    mkdir("");
    3daa:	00003497          	auipc	s1,0x3
    3dae:	53648493          	add	s1,s1,1334 # 72e0 <malloc+0x167e>
    link("README", "");
    3db2:	00002a97          	auipc	s5,0x2
    3db6:	176a8a93          	add	s5,s5,374 # 5f28 <malloc+0x2c6>
    fd = open("xx", O_CREATE);
    3dba:	00004997          	auipc	s3,0x4
    3dbe:	91698993          	add	s3,s3,-1770 # 76d0 <malloc+0x1a6e>
    3dc2:	a891                	j	3e16 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3dc4:	85da                	mv	a1,s6
    3dc6:	00004517          	auipc	a0,0x4
    3dca:	a1a50513          	add	a0,a0,-1510 # 77e0 <malloc+0x1b7e>
    3dce:	00002097          	auipc	ra,0x2
    3dd2:	ddc080e7          	jalr	-548(ra) # 5baa <printf>
      exit(1);
    3dd6:	4505                	li	a0,1
    ...
    3de6:	a1650513          	add	a0,a0,-1514 # 77f8 <malloc+0x1b96>
    3dea:	00002097          	auipc	ra,0x2
    3dee:	dc0080e7          	jalr	-576(ra) # 5baa <printf>
      exit(1);
    3df2:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3e7a:	18a98993          	add	s3,s3,394 # 7000 <malloc+0x139e>
    unlink("irefd");
    3e7e:	00004917          	auipc	s2,0x4
    3e82:	95a90913          	add	s2,s2,-1702 # 77d8 <malloc+0x1b76>
    chdir("..");
    3e86:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3ea2:	10a50513          	add	a0,a0,266 # 6fa8 <malloc+0x1346>
...
0000000000003ec2 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3ed2:	94250513          	add	a0,a0,-1726 # 7810 <malloc+0x1bae>
  ...
  if(pid == 0){
    ...
    3ef6:	91e50513          	add	a0,a0,-1762 # 7810 <malloc+0x1bae>
    ...
    3f0c:	92850513          	add	a0,a0,-1752 # 7830 <malloc+0x1bce>
    3f10:	00002097          	auipc	ra,0x2
    3f14:	c9a080e7          	jalr	-870(ra) # 5baa <printf>
      exit(1);
    3f18:	4505                	li	a0,1
    ...
    3f28:	8f450513          	add	a0,a0,-1804 # 7818 <malloc+0x1bb6>
    3f2c:	00002097          	auipc	ra,0x2
    3f30:	c7e080e7          	jalr	-898(ra) # 5baa <printf>
    exit(1);
    3f34:	4505                	li	a0,1
    ...
    3f44:	69850513          	add	a0,a0,1688 # 65d8 <malloc+0x976>
    3f48:	00002097          	auipc	ra,0x2
    3f4c:	c62080e7          	jalr	-926(ra) # 5baa <printf>
    exit(1);
    3f50:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3f72:	8a250513          	add	a0,a0,-1886 # 7810 <malloc+0x1bae>
    ...
    3f86:	84650513          	add	a0,a0,-1978 # 67c8 <malloc+0xb66>
    3f8a:	00002097          	auipc	ra,0x2
    3f8e:	c20080e7          	jalr	-992(ra) # 5baa <printf>
    exit(1);
    3f92:	4505                	li	a0,1
...
0000000000003fb4 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3fc4:	89850513          	add	a0,a0,-1896 # 7858 <malloc+0x1bf6>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3ff0:	86c50513          	add	a0,a0,-1940 # 7858 <malloc+0x1bf6>
  ...
  sleep(10); // one second
    ...
    4028:	77450513          	add	a0,a0,1908 # 6798 <malloc+0xb36>
    ...
    4042:	81a48493          	add	s1,s1,-2022 # 7858 <malloc+0x1bf6>
    4046:	4581                	li	a1,0
    4048:	8526                	mv	a0,s1
    ...
    406a:	7f250513          	add	a0,a0,2034 # 7858 <malloc+0x1bf6>
...
000000000000408a <killstatus>:
{
  ...
  exit(0);
    ...
    40f0:	4ec50513          	add	a0,a0,1260 # 65d8 <malloc+0x976>
    40f4:	00002097          	auipc	ra,0x2
    40f8:	ab6080e7          	jalr	-1354(ra) # 5baa <printf>
      exit(1);
    40fc:	4505                	li	a0,1
    ...
    4116:	75650513          	add	a0,a0,1878 # 7868 <malloc+0x1c06>
    411a:	00002097          	auipc	ra,0x2
    411e:	a90080e7          	jalr	-1392(ra) # 5baa <printf>
       exit(1);
    4122:	4505                	li	a0,1
...
000000000000412c <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    4156:	64650513          	add	a0,a0,1606 # 6798 <malloc+0xb36>
    415a:	00002097          	auipc	ra,0x2
    415e:	a50080e7          	jalr	-1456(ra) # 5baa <printf>
    exit(1);
    4162:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    4184:	45850513          	add	a0,a0,1112 # 65d8 <malloc+0x976>
    4188:	00002097          	auipc	ra,0x2
    418c:	a22080e7          	jalr	-1502(ra) # 5baa <printf>
    exit(1);
    4190:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    41c8:	c2c58593          	add	a1,a1,-980 # 5df0 <malloc+0x18e>
    ...
    41f2:	3ea50513          	add	a0,a0,1002 # 65d8 <malloc+0x976>
    41f6:	00002097          	auipc	ra,0x2
    41fa:	9b4080e7          	jalr	-1612(ra) # 5baa <printf>
     exit(1);
    41fe:	4505                	li	a0,1
    ...
    420e:	67e50513          	add	a0,a0,1662 # 7888 <malloc+0x1c26>
    4212:	00002097          	auipc	ra,0x2
    4216:	998080e7          	jalr	-1640(ra) # 5baa <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    422e:	b9658593          	add	a1,a1,-1130 # bdc0 <buf>
    ...
    424a:	65a50513          	add	a0,a0,1626 # 78a0 <malloc+0x1c3e>
    424e:	00002097          	auipc	ra,0x2
    4252:	95c080e7          	jalr	-1700(ra) # 5baa <printf>
}
  ...
  printf("kill... ");
    ...
    4276:	64650513          	add	a0,a0,1606 # 78b8 <malloc+0x1c56>
    427a:	00002097          	auipc	ra,0x2
    427e:	930080e7          	jalr	-1744(ra) # 5baa <printf>
  kill(pid1);
    4282:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    42a4:	62850513          	add	a0,a0,1576 # 78c8 <malloc+0x1c66>
    42a8:	00002097          	auipc	ra,0x2
    42ac:	902080e7          	jalr	-1790(ra) # 5baa <printf>
  wait(0);
    42b0:	4501                	li	a0,0
...
00000000000042d0 <reparent>:
{
  ...
  exit(0);
    ...
    4324:	2b850513          	add	a0,a0,696 # 65d8 <malloc+0x976>
    4328:	00002097          	auipc	ra,0x2
    432c:	882080e7          	jalr	-1918(ra) # 5baa <printf>
      exit(1);
    4330:	4505                	li	a0,1
    ...
    4340:	42450513          	add	a0,a0,1060 # 6760 <malloc+0xafe>
    4344:	00002097          	auipc	ra,0x2
    4348:	866080e7          	jalr	-1946(ra) # 5baa <printf>
        exit(1);
    434c:	4505                	li	a0,1
...
0000000000004380 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    43b6:	32e50513          	add	a0,a0,814 # 66e0 <malloc+0xa7e>
    43ba:	00001097          	auipc	ra,0x1
    43be:	7f0080e7          	jalr	2032(ra) # 5baa <printf>
    exit(1);
    43c2:	4505                	li	a0,1
    ...
    43ea:	a0a58593          	add	a1,a1,-1526 # 5df0 <malloc+0x18e>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    44ae:	42e50513          	add	a0,a0,1070 # 78d8 <malloc+0x1c76>
    44b2:	00001097          	auipc	ra,0x1
    44b6:	6f8080e7          	jalr	1784(ra) # 5baa <printf>
    exit(1);
    44ba:	4505                	li	a0,1
    ...
    44ca:	11250513          	add	a0,a0,274 # 65d8 <malloc+0x976>
    44ce:	00001097          	auipc	ra,0x1
    44d2:	6dc080e7          	jalr	1756(ra) # 5baa <printf>
    exit(1);
    44d6:	4505                	li	a0,1
    ...
    4500:	6705                	lui	a4,0x1
      n += *(a+i);
    4502:	0007c683          	lbu	a3,0(a5) # 6400000 <__BSS_END__+0x63f1230>
    ...
    4516:	3e650513          	add	a0,a0,998 # 78f8 <malloc+0x1c96>
    451a:	00001097          	auipc	ra,0x1
    451e:	690080e7          	jalr	1680(ra) # 5baa <printf>
    exit(1);
    4522:	4505                	li	a0,1
...
0000000000004536 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4580:	6e6080e7          	jalr	1766(ra) # 5c62 <malloc>
    ...
    45ba:	37250513          	add	a0,a0,882 # 7928 <malloc+0x1cc6>
    45be:	00001097          	auipc	ra,0x1
    45c2:	5ec080e7          	jalr	1516(ra) # 5baa <printf>
      exit(1);
    45c6:	4505                	li	a0,1
...
00000000000045da <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4670:	2ec50513          	add	a0,a0,748 # 7958 <malloc+0x1cf6>
    4674:	00001097          	auipc	ra,0x1
    4678:	536080e7          	jalr	1334(ra) # 5baa <printf>
    exit(1);
    467c:	4505                	li	a0,1
    ...
    468c:	2f850513          	add	a0,a0,760 # 7980 <malloc+0x1d1e>
    4690:	00001097          	auipc	ra,0x1
    4694:	51a080e7          	jalr	1306(ra) # 5baa <printf>
      exit(1);
    4698:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    46d0:	27c50513          	add	a0,a0,636 # 7948 <malloc+0x1ce6>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4710:	29450513          	add	a0,a0,660 # 79a0 <malloc+0x1d3e>
    4714:	00001097          	auipc	ra,0x1
    4718:	496080e7          	jalr	1174(ra) # 5baa <printf>
    exit(1);
    471c:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    474c:	20050513          	add	a0,a0,512 # 7948 <malloc+0x1ce6>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4772:	25a50513          	add	a0,a0,602 # 79c8 <malloc+0x1d66>
    4776:	00001097          	auipc	ra,0x1
    477a:	434080e7          	jalr	1076(ra) # 5baa <printf>
    exit(1);
    477e:	4505                	li	a0,1
...
0000000000004792 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    47b6:	22e78793          	add	a5,a5,558 # 79e0 <malloc+0x1d7e>
    47ba:	f6f43823          	sd	a5,-144(s0)
    47be:	00003797          	auipc	a5,0x3
    47c2:	22a78793          	add	a5,a5,554 # 79e8 <malloc+0x1d86>
    47c6:	f6f43c23          	sd	a5,-136(s0)
    47ca:	00003797          	auipc	a5,0x3
    47ce:	22678793          	add	a5,a5,550 # 79f0 <malloc+0x1d8e>
    47d2:	f8f43023          	sd	a5,-128(s0)
    47d6:	00003797          	auipc	a5,0x3
    47da:	22278793          	add	a5,a5,546 # 79f8 <malloc+0x1d96>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    4832:	592a0a13          	add	s4,s4,1426 # bdc0 <buf>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4848:	1b450513          	add	a0,a0,436 # 69f8 <malloc+0xd96>
    484c:	00001097          	auipc	ra,0x1
    4850:	35e080e7          	jalr	862(ra) # 5baa <printf>
      exit(1);
    4854:	4505                	li	a0,1
    ...
    48c2:	14250513          	add	a0,a0,322 # 7a00 <malloc+0x1d9e>
    48c6:	00001097          	auipc	ra,0x1
    48ca:	2e4080e7          	jalr	740(ra) # 5baa <printf>
        exit(1);
    48ce:	4505                	li	a0,1
    ...
    48dc:	13850513          	add	a0,a0,312 # 7a10 <malloc+0x1dae>
    48e0:	00001097          	auipc	ra,0x1
    48e4:	2ca080e7          	jalr	714(ra) # 5baa <printf>
          exit(1);
    48e8:	4505                	li	a0,1
    ...
    4902:	12a50513          	add	a0,a0,298 # 7a28 <malloc+0x1dc6>
    4906:	00001097          	auipc	ra,0x1
    490a:	2a4080e7          	jalr	676(ra) # 5baa <printf>
          exit(1);
    490e:	4505                	li	a0,1
    ...
    4932:	49278793          	add	a5,a5,1170 # bdc0 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    498a:	0b250513          	add	a0,a0,178 # 7a38 <malloc+0x1dd6>
    498e:	00001097          	auipc	ra,0x1
    4992:	21c080e7          	jalr	540(ra) # 5baa <printf>
      exit(1);
    4996:	4505                	li	a0,1
...
00000000000049be <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    49ec:	068b8b93          	add	s7,s7,104 # 7a50 <malloc+0x1dee>
  for(i = 0; i < N; i++){
    ...
    4a2e:	02e50513          	add	a0,a0,46 # 7a58 <malloc+0x1df6>
    4a32:	00001097          	auipc	ra,0x1
    4a36:	178080e7          	jalr	376(ra) # 5baa <printf>
        exit(1);
    4a3a:	4505                	li	a0,1
    ...
    4a4c:	00850513          	add	a0,a0,8 # 7a50 <malloc+0x1dee>
  ...
  fd = open(".", 0);
    ...
    4a84:	9b850513          	add	a0,a0,-1608 # 6438 <malloc+0x7d6>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4afc:	f8050513          	add	a0,a0,-128 # 7a78 <malloc+0x1e16>
    4b00:	00001097          	auipc	ra,0x1
    4b04:	0aa080e7          	jalr	170(ra) # 5baa <printf>
        exit(1);
    4b08:	4505                	li	a0,1
    ...
    4b1c:	f8050513          	add	a0,a0,-128 # 7a98 <malloc+0x1e36>
    4b20:	00001097          	auipc	ra,0x1
    4b24:	08a080e7          	jalr	138(ra) # 5baa <printf>
        exit(1);
    4b28:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    4b54:	f7050513          	add	a0,a0,-144 # 7ac0 <malloc+0x1e5e>
    4b58:	00001097          	auipc	ra,0x1
    4b5c:	052080e7          	jalr	82(ra) # 5baa <printf>
    exit(1);
    4b60:	4505                	li	a0,1
    ...
    4b70:	a6c50513          	add	a0,a0,-1428 # 65d8 <malloc+0x976>
    4b74:	00001097          	auipc	ra,0x1
    4b78:	036080e7          	jalr	54(ra) # 5baa <printf>
      exit(1);
    4b7c:	4505                	li	a0,1
...
0000000000004d1a <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4d5a:	06a90913          	add	s2,s2,106 # bdc0 <buf>
  for(i = 0; i < N; i++){
    4d5e:	4a51                	li	s4,20
  if(fd < 0){
  ...
  fd = open("bigfile.dat", 0);
    ...
    4da2:	d5a50513          	add	a0,a0,-678 # 7af8 <malloc+0x1e96>
  ...
  for(i = 0; ; i++){
    ...
    4db8:	00c90913          	add	s2,s2,12 # bdc0 <buf>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    4e06:	d0650513          	add	a0,a0,-762 # 7b08 <malloc+0x1ea6>
    4e0a:	00001097          	auipc	ra,0x1
    4e0e:	da0080e7          	jalr	-608(ra) # 5baa <printf>
    exit(1);
    4e12:	4505                	li	a0,1
    ...
    4e22:	d0a50513          	add	a0,a0,-758 # 7b28 <malloc+0x1ec6>
    4e26:	00001097          	auipc	ra,0x1
    4e2a:	d84080e7          	jalr	-636(ra) # 5baa <printf>
      exit(1);
    4e2e:	4505                	li	a0,1
    ...
    4e3e:	d0e50513          	add	a0,a0,-754 # 7b48 <malloc+0x1ee6>
    4e42:	00001097          	auipc	ra,0x1
    4e46:	d68080e7          	jalr	-664(ra) # 5baa <printf>
    exit(1);
    4e4a:	4505                	li	a0,1
    ...
    4e5a:	d1250513          	add	a0,a0,-750 # 7b68 <malloc+0x1f06>
    4e5e:	00001097          	auipc	ra,0x1
    4e62:	d4c080e7          	jalr	-692(ra) # 5baa <printf>
      exit(1);
    4e66:	4505                	li	a0,1
    ...
    4e76:	d1650513          	add	a0,a0,-746 # 7b88 <malloc+0x1f26>
    4e7a:	00001097          	auipc	ra,0x1
    4e7e:	d30080e7          	jalr	-720(ra) # 5baa <printf>
      exit(1);
    4e82:	4505                	li	a0,1
    ...
    4e92:	d1250513          	add	a0,a0,-750 # 7ba0 <malloc+0x1f3e>
    4e96:	00001097          	auipc	ra,0x1
    4e9a:	d14080e7          	jalr	-748(ra) # 5baa <printf>
      exit(1);
    4e9e:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    4ec0:	c3c50513          	add	a0,a0,-964 # 7af8 <malloc+0x1e96>
    ...
    4ee4:	ce050513          	add	a0,a0,-800 # 7bc0 <malloc+0x1f5e>
    4ee8:	00001097          	auipc	ra,0x1
    4eec:	cc2080e7          	jalr	-830(ra) # 5baa <printf>
    exit(1);
    4ef0:	4505                	li	a0,1
...
0000000000004efa <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4f1a:	cca50513          	add	a0,a0,-822 # 7be0 <malloc+0x1f7e>
    4f1e:	00001097          	auipc	ra,0x1
    4f22:	c8c080e7          	jalr	-884(ra) # 5baa <printf>
  for(nfiles = 0; ; nfiles++){
    4f26:	4481                	li	s1,0
    name[0] = 'f';
    ...
    4f3a:	cbac8c93          	add	s9,s9,-838 # 7bf0 <malloc+0x1f8e>
    name[0] = 'f';
    ...
    4f88:	c26080e7          	jalr	-986(ra) # 5baa <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    4faa:	c5a50513          	add	a0,a0,-934 # 7c00 <malloc+0x1f9e>
    4fae:	00001097          	auipc	ra,0x1
    4fb2:	bfc080e7          	jalr	-1028(ra) # 5baa <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    5020:	c0450513          	add	a0,a0,-1020 # 7c20 <malloc+0x1fbe>
    5024:	00001097          	auipc	ra,0x1
    5028:	b86080e7          	jalr	-1146(ra) # 5baa <printf>
}
    ...
    504e:	d76a8a93          	add	s5,s5,-650 # bdc0 <buf>
      if(cc < BSIZE)
    ...
    5076:	b9e50513          	add	a0,a0,-1122 # 7c10 <malloc+0x1fae>
    507a:	00001097          	auipc	ra,0x1
    507e:	b30080e7          	jalr	-1232(ra) # 5baa <printf>
    close(fd);
    5082:	854a                	mv	a0,s2
...
0000000000005094 <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    5108:	b3450513          	add	a0,a0,-1228 # 7c38 <malloc+0x1fd6>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    5120:	cd458593          	add	a1,a1,-812 # 5df0 <malloc+0x18e>
    ...
    5136:	b2650513          	add	a0,a0,-1242 # 7c58 <malloc+0x1ff6>
    513a:	00001097          	auipc	ra,0x1
    513e:	a70080e7          	jalr	-1424(ra) # 5baa <printf>
    exit(1);
    5142:	4505                	li	a0,1
    ...
    5150:	af450513          	add	a0,a0,-1292 # 7c40 <malloc+0x1fde>
    5154:	00001097          	auipc	ra,0x1
    5158:	a56080e7          	jalr	-1450(ra) # 5baa <printf>
      exit(1);
    515c:	4505                	li	a0,1
    ...
    516a:	ada50513          	add	a0,a0,-1318 # 7c40 <malloc+0x1fde>
    516e:	00001097          	auipc	ra,0x1
    5172:	a3c080e7          	jalr	-1476(ra) # 5baa <printf>
    exit(1);
    5176:	4505                	li	a0,1
  ...
  unlink("junk");
    ...
    518e:	aae50513          	add	a0,a0,-1362 # 7c38 <malloc+0x1fd6>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    51e4:	c1098993          	add	s3,s3,-1008 # 5df0 <malloc+0x18e>
      uint64 a = (uint64) sbrk(4096);
    ...
    5216:	a9650513          	add	a0,a0,-1386 # 7ca8 <malloc+0x2046>
    521a:	00001097          	auipc	ra,0x1
    521e:	990080e7          	jalr	-1648(ra) # 5baa <printf>
        exit(1);
    5222:	4505                	li	a0,1
    ...
    5230:	a3c50513          	add	a0,a0,-1476 # 7c68 <malloc+0x2006>
    5234:	00001097          	auipc	ra,0x1
    5238:	976080e7          	jalr	-1674(ra) # 5baa <printf>
    exit(1);
    523c:	4505                	li	a0,1
    ...
    524a:	a4250513          	add	a0,a0,-1470 # 7c88 <malloc+0x2026>
    524e:	00001097          	auipc	ra,0x1
    5252:	95c080e7          	jalr	-1700(ra) # 5baa <printf>
    exit(1);
    5256:	4505                	li	a0,1
  ...
  while(1){
    ...
    5298:	a3450513          	add	a0,a0,-1484 # 7cc8 <malloc+0x2066>
    529c:	00001097          	auipc	ra,0x1
    52a0:	90e080e7          	jalr	-1778(ra) # 5baa <printf>
      exit(1);
    52a4:	4505                	li	a0,1
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    52e8:	a0450513          	add	a0,a0,-1532 # 7ce8 <malloc+0x2086>
    52ec:	00001097          	auipc	ra,0x1
    52f0:	8be080e7          	jalr	-1858(ra) # 5baa <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    5318:	9fc50513          	add	a0,a0,-1540 # 7d10 <malloc+0x20ae>
    531c:	00001097          	auipc	ra,0x1
    5320:	88e080e7          	jalr	-1906(ra) # 5baa <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    533c:	9c050513          	add	a0,a0,-1600 # 7cf8 <malloc+0x2096>
    5340:	00001097          	auipc	ra,0x1
    5344:	86a080e7          	jalr	-1942(ra) # 5baa <printf>
    exit(1);
    5348:	4505                	li	a0,1
    ...
    5364:	9b850513          	add	a0,a0,-1608 # 7d18 <malloc+0x20b6>
    5368:	00001097          	auipc	ra,0x1
    536c:	842080e7          	jalr	-1982(ra) # 5baa <printf>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    53ae:	d8678793          	add	a5,a5,-634 # 8130 <malloc+0x24ce>
    53b2:	bd040713          	add	a4,s0,-1072
    53b6:	00003317          	auipc	t1,0x3
    53ba:	16a30313          	add	t1,t1,362 # 8520 <malloc+0x28be>
  ...
  printf("usertests starting\n");
    ...
    53ee:	9ee50513          	add	a0,a0,-1554 # 7dd8 <malloc+0x2176>
    53f2:	00000097          	auipc	ra,0x0
    53f6:	7b8080e7          	jalr	1976(ra) # 5baa <printf>
  int free0 = countfree();
  ...
  if(fail){
    ...
    5428:	96c50513          	add	a0,a0,-1684 # 7d90 <malloc+0x212e>
    542c:	00000097          	auipc	ra,0x0
    5430:	77e080e7          	jalr	1918(ra) # 5baa <printf>
    exit(1);
    5434:	4505                	li	a0,1
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    5444:	8e058593          	add	a1,a1,-1824 # 7d20 <malloc+0x20be>
    ...
    545a:	cda78793          	add	a5,a5,-806 # 8130 <malloc+0x24ce>
    545e:	bd040713          	add	a4,s0,-1072
    5462:	00003317          	auipc	t1,0x3
    5466:	0be30313          	add	t1,t1,190 # 8520 <malloc+0x28be>
    ...
    549a:	95a50513          	add	a0,a0,-1702 # 7df0 <malloc+0x218e>
    549e:	00000097          	auipc	ra,0x0
    54a2:	70c080e7          	jalr	1804(ra) # 5baa <printf>
        printf("SOME TESTS FAILED\n");
    54a6:	00003a97          	auipc	s5,0x3
    54aa:	8d2a8a93          	add	s5,s5,-1838 # 7d78 <malloc+0x2116>
        if(continuous != 2)
    54ae:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    54b0:	00003b17          	auipc	s6,0x3
    54b4:	8a8b0b13          	add	s6,s6,-1880 # 7d58 <malloc+0x20f6>
    54b8:	a0dd                	j	559e <main+0x22c>
  } else if(argc == 2 && strcmp(argv[1], "-C") == 0){
    54ba:	00003597          	auipc	a1,0x3
    54be:	86e58593          	add	a1,a1,-1938 # 7d28 <malloc+0x20c6>
    ...
    54e2:	85250513          	add	a0,a0,-1966 # 7d30 <malloc+0x20ce>
    54e6:	00000097          	auipc	ra,0x0
    54ea:	6c4080e7          	jalr	1732(ra) # 5baa <printf>
    exit(1);
    54ee:	4505                	li	a0,1
    ...
    550c:	6a2080e7          	jalr	1698(ra) # 5baa <printf>
        if(continuous != 2)
  ...
  if(fail){
    ...
    5554:	82850513          	add	a0,a0,-2008 # 7d78 <malloc+0x2116>
    5558:	00000097          	auipc	ra,0x0
    555c:	652080e7          	jalr	1618(ra) # 5baa <printf>
    exit(1);
    5560:	4505                	li	a0,1
    ...
    556e:	85650513          	add	a0,a0,-1962 # 7dc0 <malloc+0x215e>
    5572:	00000097          	auipc	ra,0x0
    5576:	638080e7          	jalr	1592(ra) # 5baa <printf>
    exit(0);
    557a:	4501                	li	a0,0
    ...
    558a:	624080e7          	jalr	1572(ra) # 5baa <printf>
        if(continuous != 2)
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    592a:	c5a50513          	add	a0,a0,-934 # 8580 <digits>
    592e:	883a                	mv	a6,a4
    5930:	2705                	addw	a4,a4,1
    5932:	02c5f7bb          	remuw	a5,a1,a2
    5936:	1782                	sll	a5,a5,0x20
    5938:	9381                	srl	a5,a5,0x20
...
{
    59b0:	715d                	add	sp,sp,-80
    59b2:	e486                	sd	ra,72(sp)
    59b4:	e0a2                	sd	s0,64(sp)
    59b6:	fc26                	sd	s1,56(sp)
    59b8:	f84a                	sd	s2,48(sp)
    59ba:	f44e                	sd	s3,40(sp)
    59bc:	f052                	sd	s4,32(sp)
    59be:	ec56                	sd	s5,24(sp)
    59c0:	e85a                	sd	s6,16(sp)
    59c2:	e45e                	sd	s7,8(sp)
    59c4:	e062                	sd	s8,0(sp)
    59c6:	0880                	add	s0,sp,80
  char *s;
  int c, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    59c8:	0005c903          	lbu	s2,0(a1)
    59cc:	18090c63          	beqz	s2,5b64 <vprintf+0x1b4>
    59d0:	8aaa                	mv	s5,a0
    59d2:	8bb2                	mv	s7,a2
    59d4:	00158493          	add	s1,a1,1
  state = 0;
    59d8:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    59da:	02500a13          	li	s4,37
    59de:	4b55                	li	s6,21
    59e0:	a839                	j	59fe <vprintf+0x4e>
        putc(fd, c);
    59e2:	85ca                	mv	a1,s2
    59e4:	8556                	mv	a0,s5
    59e6:	00000097          	auipc	ra,0x0
    59ea:	efc080e7          	jalr	-260(ra) # 58e2 <putc>
    59ee:	a019                	j	59f4 <vprintf+0x44>
    } else if(state == '%'){
    59f0:	01498d63          	beq	s3,s4,5a0a <vprintf+0x5a>
  for(i = 0; fmt[i]; i++){
    59f4:	0485                	add	s1,s1,1
    59f6:	fff4c903          	lbu	s2,-1(s1)
    59fa:	16090563          	beqz	s2,5b64 <vprintf+0x1b4>
    if(state == 0){
    59fe:	fe0999e3          	bnez	s3,59f0 <vprintf+0x40>
      if(c == '%'){
    5a02:	ff4910e3          	bne	s2,s4,59e2 <vprintf+0x32>
        state = '%';
    5a06:	89d2                	mv	s3,s4
    5a08:	b7f5                	j	59f4 <vprintf+0x44>
      if(c == 'd'){
    5a0a:	13490263          	beq	s2,s4,5b2e <vprintf+0x17e>
    5a0e:	f9d9079b          	addw	a5,s2,-99
    5a12:	0ff7f793          	zext.b	a5,a5
    5a16:	12fb6563          	bltu	s6,a5,5b40 <vprintf+0x190>
    5a1a:	f9d9079b          	addw	a5,s2,-99
    5a1e:	0ff7f713          	zext.b	a4,a5
    5a22:	10eb6f63          	bltu	s6,a4,5b40 <vprintf+0x190>
    5a26:	00271793          	sll	a5,a4,0x2
    5a2a:	00003717          	auipc	a4,0x3
    5a2e:	afe70713          	add	a4,a4,-1282 # 8528 <malloc+0x28c6>
    5a32:	97ba                	add	a5,a5,a4
    5a34:	439c                	lw	a5,0(a5)
    5a36:	97ba                	add	a5,a5,a4
    5a38:	8782                	jr	a5
        printint(fd, va_arg(ap, int), 10, 1);
    5a3a:	008b8913          	add	s2,s7,8
    5a3e:	4685                	li	a3,1
    5a40:	4629                	li	a2,10
    5a42:	000ba583          	lw	a1,0(s7)
    5a46:	8556                	mv	a0,s5
    5a48:	00000097          	auipc	ra,0x0
    5a4c:	ebc080e7          	jalr	-324(ra) # 5904 <printint>
    5a50:	8bca                	mv	s7,s2
      } else {
      ...
      state = 0;
    5a52:	4981                	li	s3,0
    5a54:	b745                	j	59f4 <vprintf+0x44>
        printint(fd, va_arg(ap, uint64), 10, 0);
    5a56:	008b8913          	add	s2,s7,8
    5a5a:	4681                	li	a3,0
    5a5c:	4629                	li	a2,10
    5a5e:	000ba583          	lw	a1,0(s7)
    5a62:	8556                	mv	a0,s5
    5a64:	00000097          	auipc	ra,0x0
    5a68:	ea0080e7          	jalr	-352(ra) # 5904 <printint>
    5a6c:	8bca                	mv	s7,s2
      state = 0;
    5a6e:	4981                	li	s3,0
    5a70:	b751                	j	59f4 <vprintf+0x44>
        printint(fd, va_arg(ap, int), 16, 0);
    5a72:	008b8913          	add	s2,s7,8
    5a76:	4681                	li	a3,0
    5a78:	4641                	li	a2,16
    5a7a:	000ba583          	lw	a1,0(s7)
    5a7e:	8556                	mv	a0,s5
    5a80:	00000097          	auipc	ra,0x0
    5a84:	e84080e7          	jalr	-380(ra) # 5904 <printint>
    5a88:	8bca                	mv	s7,s2
      state = 0;
    5a8a:	4981                	li	s3,0
    5a8c:	b7a5                	j	59f4 <vprintf+0x44>
        printptr(fd, va_arg(ap, uint64));
    5a8e:	008b8c13          	add	s8,s7,8
    5a92:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    5a96:	03000593          	li	a1,48
    5a9a:	8556                	mv	a0,s5
    5a9c:	00000097          	auipc	ra,0x0
    5aa0:	e46080e7          	jalr	-442(ra) # 58e2 <putc>
  putc(fd, 'x');
    5aa4:	07800593          	li	a1,120
    5aa8:	8556                	mv	a0,s5
    5aaa:	00000097          	auipc	ra,0x0
    5aae:	e38080e7          	jalr	-456(ra) # 58e2 <putc>
    5ab2:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5ab4:	00003b97          	auipc	s7,0x3
    5ab8:	accb8b93          	add	s7,s7,-1332 # 8580 <digits>
    5abc:	03c9d793          	srl	a5,s3,0x3c
    5ac0:	97de                	add	a5,a5,s7
    5ac2:	0007c583          	lbu	a1,0(a5)
    5ac6:	8556                	mv	a0,s5
    5ac8:	00000097          	auipc	ra,0x0
    5acc:	e1a080e7          	jalr	-486(ra) # 58e2 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5ad0:	0992                	sll	s3,s3,0x4
    5ad2:	397d                	addw	s2,s2,-1
    5ad4:	fe0914e3          	bnez	s2,5abc <vprintf+0x10c>
        printptr(fd, va_arg(ap, uint64));
    5ad8:	8be2                	mv	s7,s8
      state = 0;
    5ada:	4981                	li	s3,0
    5adc:	bf21                	j	59f4 <vprintf+0x44>
        s = va_arg(ap, char*);
    5ade:	008b8993          	add	s3,s7,8
    5ae2:	000bb903          	ld	s2,0(s7)
        if(s == 0)
    5ae6:	02090163          	beqz	s2,5b08 <vprintf+0x158>
        while(*s != 0){
    5aea:	00094583          	lbu	a1,0(s2)
    5aee:	c9a5                	beqz	a1,5b5e <vprintf+0x1ae>
          putc(fd, *s);
    5af0:	8556                	mv	a0,s5
    5af2:	00000097          	auipc	ra,0x0
    5af6:	df0080e7          	jalr	-528(ra) # 58e2 <putc>
          s++;
    5afa:	0905                	add	s2,s2,1
        while(*s != 0){
    5afc:	00094583          	lbu	a1,0(s2)
    5b00:	f9e5                	bnez	a1,5af0 <vprintf+0x140>
        s = va_arg(ap, char*);
    5b02:	8bce                	mv	s7,s3
      state = 0;
    5b04:	4981                	li	s3,0
    5b06:	b5fd                	j	59f4 <vprintf+0x44>
          s = "(null)";
    5b08:	00003917          	auipc	s2,0x3
    5b0c:	a1890913          	add	s2,s2,-1512 # 8520 <malloc+0x28be>
        while(*s != 0){
    5b10:	02800593          	li	a1,40
    5b14:	bff1                	j	5af0 <vprintf+0x140>
        putc(fd, va_arg(ap, uint));
    5b16:	008b8913          	add	s2,s7,8
    5b1a:	000bc583          	lbu	a1,0(s7)
    5b1e:	8556                	mv	a0,s5
    5b20:	00000097          	auipc	ra,0x0
    5b24:	dc2080e7          	jalr	-574(ra) # 58e2 <putc>
    5b28:	8bca                	mv	s7,s2
      state = 0;
    5b2a:	4981                	li	s3,0
    5b2c:	b5e1                	j	59f4 <vprintf+0x44>
        putc(fd, c);
    5b2e:	02500593          	li	a1,37
    5b32:	8556                	mv	a0,s5
    5b34:	00000097          	auipc	ra,0x0
    5b38:	dae080e7          	jalr	-594(ra) # 58e2 <putc>
      state = 0;
    5b3c:	4981                	li	s3,0
    5b3e:	bd5d                	j	59f4 <vprintf+0x44>
        putc(fd, '%');
    5b40:	02500593          	li	a1,37
    5b44:	8556                	mv	a0,s5
    5b46:	00000097          	auipc	ra,0x0
    5b4a:	d9c080e7          	jalr	-612(ra) # 58e2 <putc>
        putc(fd, c);
    5b4e:	85ca                	mv	a1,s2
    5b50:	8556                	mv	a0,s5
    ...
    5b56:	d90080e7          	jalr	-624(ra) # 58e2 <putc>
      state = 0;
    5b5a:	4981                	li	s3,0
    5b5c:	bd61                	j	59f4 <vprintf+0x44>
        s = va_arg(ap, char*);
    5b5e:	8bce                	mv	s7,s3
      state = 0;
    5b60:	4981                	li	s3,0
    5b62:	bd49                	j	59f4 <vprintf+0x44>
    }
  }
}
    5b64:	60a6                	ld	ra,72(sp)
    5b66:	6406                	ld	s0,64(sp)
    5b68:	74e2                	ld	s1,56(sp)
    5b6a:	7942                	ld	s2,48(sp)
    5b6c:	79a2                	ld	s3,40(sp)
    5b6e:	7a02                	ld	s4,32(sp)
    5b70:	6ae2                	ld	s5,24(sp)
    5b72:	6b42                	ld	s6,16(sp)
    5b74:	6ba2                	ld	s7,8(sp)
    5b76:	6c02                	ld	s8,0(sp)
    5b78:	6161                	add	sp,sp,80
    5b7a:	8082                	ret
...
{
    5b7c:	715d                	add	sp,sp,-80
    5b7e:	ec06                	sd	ra,24(sp)
    5b80:	e822                	sd	s0,16(sp)
    5b82:	1000                	add	s0,sp,32
  ...
  vprintf(fd, fmt, ap);
    ...
    5b9e:	e16080e7          	jalr	-490(ra) # 59b0 <vprintf>
}
    5ba2:	60e2                	ld	ra,24(sp)
    5ba4:	6442                	ld	s0,16(sp)
    5ba6:	6161                	add	sp,sp,80
    5ba8:	8082                	ret
...
{
    5baa:	711d                	add	sp,sp,-96
    5bac:	ec06                	sd	ra,24(sp)
    5bae:	e822                	sd	s0,16(sp)
    5bb0:	1000                	add	s0,sp,32
...
free(void *ap)
{
    5be0:	1141                	add	sp,sp,-16
    5be2:	e422                	sd	s0,8(sp)
    5be4:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5be6:	ff050693          	add	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5bea:	00003797          	auipc	a5,0x3
    5bee:	9b67b783          	ld	a5,-1610(a5) # 85a0 <freep>
    5bf2:	a02d                	j	5c1c <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5bf4:	4618                	lw	a4,8(a2)
    5bf6:	9f2d                	addw	a4,a4,a1
    5bf8:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5bfc:	6398                	ld	a4,0(a5)
    5bfe:	6310                	ld	a2,0(a4)
    5c00:	a83d                	j	5c3e <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5c02:	ff852703          	lw	a4,-8(a0)
    5c06:	9f31                	addw	a4,a4,a2
    5c08:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    5c0a:	ff053683          	ld	a3,-16(a0)
    5c0e:	a091                	j	5c52 <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5c10:	6398                	ld	a4,0(a5)
    5c12:	00e7e463          	bltu	a5,a4,5c1a <free+0x3a>
    5c16:	00e6ea63          	bltu	a3,a4,5c2a <free+0x4a>
{
    5c1a:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5c1c:	fed7fae3          	bgeu	a5,a3,5c10 <free+0x30>
    5c20:	6398                	ld	a4,0(a5)
    5c22:	00e6e463          	bltu	a3,a4,5c2a <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5c26:	fee7eae3          	bltu	a5,a4,5c1a <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    5c2a:	ff852583          	lw	a1,-8(a0)
    5c2e:	6390                	ld	a2,0(a5)
    5c30:	02059813          	sll	a6,a1,0x20
    5c34:	01c85713          	srl	a4,a6,0x1c
    5c38:	9736                	add	a4,a4,a3
    5c3a:	fae60de3          	beq	a2,a4,5bf4 <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    5c3e:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5c42:	4790                	lw	a2,8(a5)
    5c44:	02061593          	sll	a1,a2,0x20
    5c48:	01c5d713          	srl	a4,a1,0x1c
    5c4c:	973e                	add	a4,a4,a5
    5c4e:	fae68ae3          	beq	a3,a4,5c02 <free+0x22>
    p->s.ptr = bp->s.ptr;
    5c52:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    5c54:	00003717          	auipc	a4,0x3
    5c58:	94f73623          	sd	a5,-1716(a4) # 85a0 <freep>
}
    5c5c:	6422                	ld	s0,8(sp)
    5c5e:	0141                	add	sp,sp,16
    5c60:	8082                	ret

0000000000005c62 <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    5c62:	7139                	add	sp,sp,-64
    5c64:	fc06                	sd	ra,56(sp)
    5c66:	f822                	sd	s0,48(sp)
    5c68:	f426                	sd	s1,40(sp)
    5c6a:	f04a                	sd	s2,32(sp)
    5c6c:	ec4e                	sd	s3,24(sp)
    5c6e:	e852                	sd	s4,16(sp)
    5c70:	e456                	sd	s5,8(sp)
    5c72:	e05a                	sd	s6,0(sp)
    5c74:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    5c76:	02051493          	sll	s1,a0,0x20
    5c7a:	9081                	srl	s1,s1,0x20
    5c7c:	04bd                	add	s1,s1,15
    5c7e:	8091                	srl	s1,s1,0x4
    5c80:	0014899b          	addw	s3,s1,1
    5c84:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
    5c86:	00003517          	auipc	a0,0x3
    5c8a:	91a53503          	ld	a0,-1766(a0) # 85a0 <freep>
    5c8e:	c515                	beqz	a0,5cba <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5c90:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5c92:	4798                	lw	a4,8(a5)
    5c94:	02977f63          	bgeu	a4,s1,5cd2 <malloc+0x70>
  if(nu < 4096)
    5c98:	8a4e                	mv	s4,s3
    5c9a:	0009871b          	sext.w	a4,s3
    5c9e:	6685                	lui	a3,0x1
    5ca0:	00d77363          	bgeu	a4,a3,5ca6 <malloc+0x44>
    5ca4:	6a05                	lui	s4,0x1
    5ca6:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    5caa:	004a1a1b          	sllw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    5cae:	00003917          	auipc	s2,0x3
    5cb2:	8f290913          	add	s2,s2,-1806 # 85a0 <freep>
  if(p == (char*)-1)
    5cb6:	5afd                	li	s5,-1
    5cb8:	a895                	j	5d2c <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    5cba:	00009797          	auipc	a5,0x9
    5cbe:	10678793          	add	a5,a5,262 # edc0 <base>
    5cc2:	00003717          	auipc	a4,0x3
    5cc6:	8cf73f23          	sd	a5,-1826(a4) # 85a0 <freep>
    5cca:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    5ccc:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    5cd0:	b7e1                	j	5c98 <malloc+0x36>
      if(p->s.size == nunits)
    5cd2:	02e48c63          	beq	s1,a4,5d0a <malloc+0xa8>
        p->s.size -= nunits;
    5cd6:	4137073b          	subw	a4,a4,s3
    5cda:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5cdc:	02071693          	sll	a3,a4,0x20
    5ce0:	01c6d713          	srl	a4,a3,0x1c
    5ce4:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    5ce6:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5cea:	00003717          	auipc	a4,0x3
    5cee:	8aa73b23          	sd	a0,-1866(a4) # 85a0 <freep>
      return (void*)(p + 1);
    5cf2:	01078513          	add	a0,a5,16
      if((p = morecore(nunits)) == 0)
        return 0;
  }
}
    5cf6:	70e2                	ld	ra,56(sp)
    5cf8:	7442                	ld	s0,48(sp)
    5cfa:	74a2                	ld	s1,40(sp)
    5cfc:	7902                	ld	s2,32(sp)
    5cfe:	69e2                	ld	s3,24(sp)
    5d00:	6a42                	ld	s4,16(sp)
    5d02:	6aa2                	ld	s5,8(sp)
    5d04:	6b02                	ld	s6,0(sp)
    5d06:	6121                	add	sp,sp,64
    5d08:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    5d0a:	6398                	ld	a4,0(a5)
    5d0c:	e118                	sd	a4,0(a0)
    5d0e:	bff1                	j	5cea <malloc+0x88>
  hp->s.size = nu;
    5d10:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    5d14:	0541                	add	a0,a0,16
    5d16:	00000097          	auipc	ra,0x0
    5d1a:	eca080e7          	jalr	-310(ra) # 5be0 <free>
  return freep;
    5d1e:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    5d22:	d971                	beqz	a0,5cf6 <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5d24:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5d26:	4798                	lw	a4,8(a5)
    5d28:	fa9775e3          	bgeu	a4,s1,5cd2 <malloc+0x70>
    if(p == freep)
    5d2c:	00093703          	ld	a4,0(s2)
    5d30:	853e                	mv	a0,a5
    5d32:	fef719e3          	bne	a4,a5,5d24 <malloc+0xc2>
  p = sbrk(nu * sizeof(Header));
    5d36:	8552                	mv	a0,s4
    5d38:	00000097          	auipc	ra,0x0
    5d3c:	b82080e7          	jalr	-1150(ra) # 58ba <sbrk>
  if(p == (char*)-1)
    5d40:	fd5518e3          	bne	a0,s5,5d10 <malloc+0xae>
        return 0;
    5d44:	4501                	li	a0,0
    5d46:	bf45                	j	5cf6 <malloc+0x94>
